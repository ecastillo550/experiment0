...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en"><head>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><title>Dokeos 2.2 MOBILE - Installation guide</title>
	...
	<div id="header">
		<div id="header1">
				<div class="headerinner">
					<div id="institution">Dokeos 2.2 TABLET Installation guide</div>
				</div>
		</div>
		<div id="header2">
			<div class="headerinner">
	...
	<div id="main">
		...
		<div id="content">
			...
			<h2>Dokeos 2.2 MOBILE Installation Guide</h2>
			<p>Thank you for downloading Dokeos 2.2 MOBILE<br />
</p>
			<ul>
				<li>Preview of <a href="http://www.dokeos.com/en/node/58">Dokeos features&nbsp;</a></li>
				<li>Test Dokeos on <a href="http://campus.dokeos.com">Demo Campus</a></li>
			</ul>
			...
			<ol>
				...
				<li><a href="#2._Installation_of_Dokeos_LMS">Installation of Dokeos 2.2 MOBILE<br />
</a></li>
				...
				<li><a href="#6._LDAP">LDAP / Active Directory</a></li><li><a href="#7._Oogie_PowerPoint__Impress_conversion">OogieRapid Learning<br />
</a></li>
  ...
  <li><a href="#11contact">Contact</a><br />
		...
		<p>Dokeos is mainly a LMS running <strong>Apache 2, 2.0</strong>, <strong>MySQL 5.1</strong> and <strong>PHP 5.3</strong> (the so called <strong>AMP</strong> trilogy).
		...
		<h2><a name="2._Installation_of_Dokeos_LMS" id="2._Installation_of_Dokeos_LMS">2. Installation of Dokeos LMS</a></h2>
		<ul>
...
<h3>3.1 From Dokeos 2.0 or Dokeos 2.1<br />
</h3>

		<em>If you upgrade from Dokeos 2.0</em> :
		
<ul>
<li>check that you haven't left any customised stylesheet or image*</li><li>download the Dokeos 2.1 TABLET install package from the <a href="http://www.dokeos.com/en/node/33">Dokeos download page</a></li><li> unzip the new files of Dokeos 2.1 TABLET over the files of the older version</li><li> point your browser on your portal URL + main/install/</li><li> choose your language and click&nbsp;<em>Upgrade from 2.0.<br />
</em></li>
</ul>
...
<h3>3.1 From Dokeos 1.8.x</h3>
		...
		<ul>
			...
			<li>download the Dokeos 2.1 TABLET install package from the <a href="http://www.dokeos.com/en/node/33">Dokeos download page</a></li>
	  		<li> unzip the new files of Dokeos 2.1 TABLET over the files of the older version</li>
		...
		old to the new installation.
			...
			is important to allow the move of the courses/ and upload/ directories to the new install</li>
	  		<li> download the Dokeos 2.1 TABLET package from the <a href="http://www.dokeos.com/en/node/33">Dokeos download page</a></li>
	  		<li> unzip the new files of Dokeos 2.1 TABLET in the main Dokeos directory. The new directory <em>main</em> should be located directly inside your Dokeos root folder</li>
		...
		<em> NOTE: </em> The upgrade from 1.6.x to 2.1 TABLET implies a revision of
		...
		simply reused. The good news is the version 2.1 TABLET allows you to create
		...
		<h3>3.4 Quick-upgrade from 1.8.x or 2.0 guide for Linux servers<br />
</h3>
		...
		<ul>
		  ...
		  <li>wget http://www.dokeos.com/download/dokeos21.zip</li>
		  <li>unzip zxvf dokeos21.zip</li>
		  <li>sudo cp -ra dokeos21/* /var/www/dokeos/</li>
		  <li>rm dokeos21.zip</li>
		  <li>sudo rm -r dokeos21/</li>
		</ul>
