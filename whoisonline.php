			...
			if (api_get_setting('allow_social_tool')=='true' && api_get_user_id()<>$user_anonymous && api_get_user_id()<>0) {
				if ($user_info['user_id'] != api_get_user_id() && !api_is_anonymous($user_info['user_id'])) {
					...
					if ($user_relation==0 || $user_relation==6) {
						$table_row[] = '<a href="main/messages/send_message_to_userfriend.inc.php?view_panel=2&height=365&width=610&user_friend='.$user_info['user_id'].'" class="thickbox" title="'.get_lang('SendInvitation').'">'.Display :: return_icon('pixel.gif', get_lang('SocialInvitationToFriends'),array('class'=>'actionplaceholdericon actionmailsendjoingroups')).'&nbsp;'.get_lang('SendInvitation').'</a><br />
										<a href="main/messages/send_message_to_userfriend.inc.php?view_panel=1&height=365&width=610&user_friend='.$user_info['user_id'].'" class="thickbox" title="'.get_lang('SendAMessage').'">'.Display :: return_icon('pixel.gif', get_lang('SendAMessage'),array('class'=>'actionplaceholdericon actionmailsend')).'&nbsp;'.get_lang('SendAMessage').'</a>';
					} else {
						$table_row[] = '<a href="main/messages/send_message_to_userfriend.inc.php?view_panel=1&height=365&width=610&user_friend='.$user_info['user_id'].'" class="thickbox" title="'.get_lang('SendAMessage').'">'.Display :: return_icon('pixel.gif', get_lang('SendAMessage'),array('class'=>'actionplaceholdericon actionmailsend')).'&nbsp;'.get_lang('SendAMessage').'</a>';
					}				
				}
			}
			...
			if ($safe_user_id != api_get_user_id() && !api_is_anonymous($safe_user_id)) {
				...
				if ($user_relation == 0 || $user_relation == 6) {
					echo  '<a href="main/messages/send_message_to_userfriend.inc.php?view_panel=2&height=300&width=610&user_friend='.$safe_user_id.'" class="thickbox" title="'.get_lang('SendInvitation').'">'.Display :: return_icon('pixel.gif', get_lang('SocialInvitationToFriends'),array('class'=>'actionplaceholdericon actionmailsendjoingroups')).'&nbsp;'.get_lang('SendInvitation').'</a><br />
						   <a href="main/messages/send_message_to_userfriend.inc.php?view_panel=1&height=310&width=610&user_friend='.$safe_user_id.'" class="thickbox" title="'.get_lang('SendAMessage').'">'.Display :: return_icon('pixel.gif', get_lang('SendAMessage'),array('class'=>'actionplaceholdericon actionmailsend')).'&nbsp;'.get_lang('SendAMessage').'</a>';
				} else {
					echo  '<a href="main/messages/send_message_to_userfriend.inc.php?view_panel=1&height=310&width=610&user_friend='.$safe_user_id.'" class="thickbox" title="'.get_lang('SendAMessage').'">'.Display :: return_icon('pixel.gif', get_lang('SendAMessage'),array('class'=>'actionplaceholdericon actionmailsend')).'&nbsp;'.get_lang('SendAMessage').'</a>';
				}
			}
		}
