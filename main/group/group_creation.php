...
// add image to table
	...
	$form->addElement('radio', 'scenario', null, '<b>'.get_lang('Tutoring').'</b>', 1);
      //$form->addElement('html','<table width="100%" border="0"><tr><td width="15%" text-align=""></td><td>'.get_lang('ScenarioText1').'</td></tr>'.'<tr><td width="15%">&nbsp;</td><td>'.get_lang('ScenarioTools1').'</td></tr></table>');//
        $form->addElement('html','<table width="100%" border="0"><tr><td width="15%">&nbsp;</td><td width="50%" valign="middle">'.get_lang('ScenarioText1').'<br />'.get_lang('ScenarioTools1').'</td><td width="200" align="right">'.Display::return_icon('scenario1.png').'</td></tr>  '.'</table>');
	...
	$form->addElement('radio', 'scenario', null, '<b>'.get_lang('Collaboration').'</b>', 2);
      //$form->addElement('html','<table width="100%" border="0"><tr><td width="15%">&nbsp;</td><td>'.get_lang('ScenarioText2').'</td></tr>'.'<tr><td width="15%">&nbsp;</td><td>'.get_lang('ScenarioTools2').'</td></tr></table>');
        $form->addElement('html','<table width="100%" border="0"><tr><td width="15%">&nbsp;</td><td width="60%" valign="middle">'.get_lang('ScenarioText2').'<br />'.get_lang('ScenarioTools2').'</td><td width="200" align="right">'.Display::return_icon('scenario2.png').'</td></tr>  '.'</table>');
	...
	$form->addElement('html','<table width="100%" border="0"><tr><td width="15%">&nbsp;</td><td width="60%" valign="middle">'.get_lang('ScenarioText3').'<br />'.get_lang('ScenarioTools3').'</td><td width="200" align="right">'.Display::return_icon('scenario3.png').'</td></tr>  '.'</table>');
