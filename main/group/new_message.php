...
function manage_form ($default, $select_from_user_list = null) {
	...
	$form = new FormValidator('compose_message',null,api_get_self().'?'.api_get_cidReq().'&id_session='.api_get_session_id().'&group_id='.intval($group_id),null,array('enctype'=>'multipart/form-data'));
	if (!empty($group_id)) {
