...
echo '<div id="content">';
echo '<div id="chat_box_content"></div>';
/*
-----------------------------------------------------------
	Main Display Area
-----------------------------------------------------------
...
//			echo Display::return_icon('pixel.gif','',array('class' => 'actionplaceholdericon actiongrouptoolvisible','onclick' => 'change_visibility(\'invisible\',\'work_state\')'));
		...
		echo '<a href="../work/work.php?'.api_get_cidreq()."&gidReg=".$_SESSION['_gid']."&group_id=".$current_group['id'].'">'.Display::return_icon('pixel.gif',get_lang('Work'),array('class' => 'toolactionplaceholdericon toolactionassignment')).get_lang('Work').'</a>';
	}
	else {
		if(api_is_allowed_to_edit()){
