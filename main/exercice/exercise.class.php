 ...
 class Exercise {
  ...
  function read($id) {
   ...
   if ($count_scenario == 0) {
      ...
      $sql = "SELECT id,title,description,sound,type,random,active, results_disabled, max_attempt,start_time,end_time,feedback_type,expired_time, certif_template, certif_min_score FROM $TBL_EXERCICES WHERE id='" . Database::escape_string($id) . "'";
      ...
      expired_time, session_id, certif_template, certif_min_score) VALUES('".$rowquiz->id."','".$this->scenario."',
      ...
      '".$session_id."','".$rowquiz->certif_template."','".$rowquiz->certif_min_score."')";
   ...
   if (is_numeric($this->scenario)) {
     $sql = "SELECT title,description,sound,type,random,active, results_disabled, max_attempt,start_time,end_time,feedback_type,expired_time, certif_template, certif_min_score FROM $TBL_EXERCICES_SCENARIO WHERE exercice_id='" . Database::escape_string($id) . "' AND scenario_type='" . $this->scenario . "'";
   } else {
     $sql = "SELECT title,description,sound,type,random,active, results_disabled, max_attempt,start_time,end_time,feedback_type,expired_time, certif_template, certif_min_score FROM $TBL_EXERCICES WHERE id='" . Database::escape_string($id) . "'";
   }
  ...
  function save($type_e='') {
   ...
   if ($id) {
    ...
    $sql = "INSERT INTO $TBL_EXERCICES (start_time,end_time,title,description,sound,type,random,active, results_disabled, max_attempt,feedback_type,expired_time, position, certif_template, certif_min_score)
					VALUES(
						'$start_time','$end_time',
						'" . $name ."',
  ...
  function createScenarioForm($form) {
    ...
    $form->addElement('html', '<div class="content-scenario">');
    
    // Name block
    $form->addElement('text', 'exerciseTitle', get_lang('ExerciseName'), 'class="focus";style="width:400px;"');
    $renderer->setElementTemplate('<table><tr><td><!-- BEGIN error --><!-- END error -->{label}: {element}</td></tr></table>', 'exerciseTitle');
    ...
    $form->addElement('html', '         </td>
                                        ...
                                        <td rowspan="3" valign="middle" width="290px">'.Display::return_icon('quizgallery/answer_shuffle.png').'</td>
                                    </tr>
                                    <tr>
                                        <td valign="top">');
    ...
    $form->addElement('html', '         </td>
                                        ...
                                        <td rowspan="4" valign="middle" width="290px">'.Display::return_icon('quizgallery/avatar_mirrow.png').'</td>
                                    </tr>
                                    <tr>
                                        <td valign="top">');
