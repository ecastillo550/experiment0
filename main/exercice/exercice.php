...
?></td> 
   <td style="width:200px;" align="center">
       <?php 
        ...
        $last_attempt    = $obj_certificate->getLastScoreInfoQuiz(api_get_user_id(), api_get_course_id(),0,0,0,$eid);
        $certif_available = $obj_certificate->isUserAllowedGetCertificate(api_get_user_id(), 'quiz', $last_attempt['exe_id'], api_get_course_id());
        if ($certif_available) {
            echo '<a id="certificate-'.$eid.'-link" href="#">'.Display::return_icon('certificate48x48.png', get_lang('GetCertificate')).'</a>';
            $obj_certificate->displayCertificate('html', 'quiz', $eid, api_get_course_id(), null, true);
        }
       ?>       
   </td>
  </tr>
