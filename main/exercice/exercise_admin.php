...
<div id="exercise_admin_left_container" class="<?php echo $sub_container_class; ?>" >
 ...
 <?php
	...
	echo '<a href="exercise_category.php?<?php echo api_get_cidreq()?>&action=add_category">'.Display :: return_icon("pixel.gif", get_lang("Categories"),array('class'=>'actionplaceholdericon actioncategoriequiz')) . get_lang("Categories").'</a>';
	}
        if (!isset($_GET['lp_id'])) {?>		
