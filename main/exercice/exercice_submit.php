...
if ($exercise_row['expired_time'] != 0) {
 echo '<div width="100%" align="right" id="wrapper-clock" style="margin-bottom:40px;"><div id="square" class="square"><div id="text-content" align="center" class="count_down"></div></div></div>';
...
$submit_btn = '';
 if (!empty($questionList)) {
    $submit_btn = "<button style='margin-top:-42px;' class='next' type='submit' name='submit_save' id='submit_save'>"; 
