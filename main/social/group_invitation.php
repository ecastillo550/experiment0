...
<tr>
  ...
  if ($ajax_search) {
  ?>
  	<input class="arrowl" name="add" type="button" onclick="remove_item(document.getElementById('destination_users'))" />
  <?php
  } else {
  ?>
  	<input class="arrowr" type="button" name="add" onclick="moveItem(document.getElementById('origin_users'), document.getElementById('destination_users'))" />
	<input class="arrowl" name="remove" type="button" onclick="moveItem(document.getElementById('destination_users'), document.getElementById('origin_users'))" />
