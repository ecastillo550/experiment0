...
?>
<div class="actions">
<a href="<?php echo api_get_path(WEB_COURSE_PATH).$course->directory; ?>"><?php Display::display_icon('pixel.gif', get_lang('CourseHomepage'),array('class'=>'toolactionplaceholdericon toolactionshome')); ?> <?php echo get_lang('CourseHomepage'); ?></a>
...
if (Database::num_rows($res) > 0)
{
	...
	while ($obj = Database::fetch_object($res))
	{
		...
		$user[] = '<a href="user_information.php?user_id='.$obj->user_id.'">'.Display::return_icon('pixel.gif',get_lang('UserInfo'),array('class'=>'actionplaceholdericon actioninfo')).'</a>';
		$users[] = $user;
	}
