...
if (isset ($_GET['search']) && $_GET['search'] == 'advanced') {
	...
	echo '<form method="POST" action="session_category_list.php?keyword='.$_GET['keyword'].'"><input type="text" id="keyword" name="keyword" value="'.Security::remove_XSS($_GET['keyword']).'"/>&nbsp;
				<button type="submit" name="name" value="'.get_lang('Search').'">'.get_lang('Search').'</button>&nbsp;
				<a href="session_category_list.php?search=advanced">'.get_lang('AdvancedSearch').'</a></form>';
	echo '</div>';
	echo '</div>';
