...
$form->addElement('radio', 'payment', get_lang('Payment'), get_lang('AllowedToUnsubscribe'), 1);
$form->addElement('radio', 'payment', null, get_lang('NotAllowedToUnsubscribe'), 0);
...
if( $form->validate()) {
	...
	if (sizeof($keys))
	{
		...
		register_course($currentCourseId, $currentCourseCode, $currentCourseRepository, $currentCourseDbName, $tutor_name, $category, $title, $course_language, $teacher_id, $expiration_date,$course_teachers,$payment);
