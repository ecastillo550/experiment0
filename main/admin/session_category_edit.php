...
if ($_POST['formSent']) {
	...
	$return = SessionManager::edit_category_session($id, $name, $description,$year_start, $month_start, $day_start, $year_end, $month_end, $day_end);
...
<div class="row"><div class="form_header"><?php echo get_lang('EditSessionCategory'); ?></div></div>
