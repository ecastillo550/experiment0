...
$(document).ready(function(){
	$(function() {
		$(".dragdrop").sortable({ opacity: 0.6,cursor: "move",cancel: ".nodrag", update: function(event, ui) {
		  ...
		  $.ajax({
			   type: "GET",
			   url: "'.api_get_path(WEB_AJAX_PATH).'user_fields.ajax.php?action=change_field_position&field_id="+Lp_id+"&new_order="+newOrder,
...
/*	echo '<div class="actions">';
    ...
    $sql = "SELECT * FROM $table_uf  ORDER BY field_order";
