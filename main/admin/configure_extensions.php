...
if(isset($_POST['activeExtension'])){
    ...
    case 'visiox' :
      ...
      if (file_exists(api_get_path(SYS_CODE_PATH).'videoconference/bbb_conf.php')){
        $sql = 'UPDATE '.$tbl_settings_current.' SET
        selected_value="true"
        WHERE variable="service_visio"
        AND subkey="active"';
        ...
        if(Database::affected_rows()>0){
          ...
          while($row = Database::fetch_array($rs)){
            ...
            if(Database::num_rows($selectres)<1)
            {
              $sql = 'INSERT INTO '.$tool_table.' SET
                  name="'.TOOL_VISIO_CONFERENCE.'",
                  link="videoconference/virtual_meeting.php",
            ...
            if(Database::num_rows($selectres)<1)
            {
              $sql = 'INSERT INTO '.$tool_table.' SET
                  name="'.TOOL_VISIO_CLASSROOM.'",
                  link="videoconference/virtual_classroom.php",
                  image="visio.gif",
                  visibility="1",
                  admin="0",
                  address="squaregrey.gif",
        ...
        $message = get_lang('ServiceNotActivated');
      }
	...
	<div id="main_visio">
		...
		<div id="extension_content_visio" style="display:none" class="accordion_content">
			...
			<table width="100%">
				<tr>
					<td align="center">
						<?php Display::display_icon('video_conference.png', get_lang('Visioconf')); ?>
					</td>
					<td align="right" width="50%" valign ="bottom" class="text_conference">
						<?php
						...
						$renderer -> setElementTemplate('<div style="float:none;">{element}</div>');
						if (file_exists(api_get_path(SYS_CODE_PATH).'videoconference/bbb_conf.php')){
							...
							//$form -> addElement('style_submit_button', 'activeExtension', get_lang('ActivateExtension'),'class="save" style="float:none;"');
						}
						else {
							//$form -> addElement('style_submit_button', 'activeExtension', get_lang('ActivateExtension'),'class="save" style="float:none;"');
						}
			...
			<table width="100%">
				<tr>
					<td valign="middle" align="center">
						<?php Display::display_icon('presentation_teacher.png', get_lang('Ppt2lp')); ?>
					</td>
					<td align="center" width="50%" class="text_oogie">
						...
						if(in_array('service_ppt2lp',$listActiveServices))
						{
							...
							$defaults['port'] = '2002';
							$defaults['size'] = '800x600';
                                                        $defaults['path_to_lzx'] = '/main/webrooms/recorder.swf';
			...
			<table width="100%">
				<tr>
					<td width="50%"align="center">
						<?php Display::display_icon('searching_avatar.png', get_lang('SearchEngine')); ?>
					</td>
					<td align="center" width="50%" valign ="bottom" class="text_library">
						<form method="POST" action="<?php echo api_get_self(); ?>">
	...
	<div id="main_serverstats">
		...
		<div id="extension_content_serverstats" style="display:none" class="accordion_content">
			...
			<table width="100%">
				<tr>
					<td width="50%" align="center">
						<?php Display::display_icon('statistics_avatar.png', get_lang('ServerStatistics')); ?>
					</td>
					<td align="center" width="50%" valign ="bottom" class="text_server">
						<form method="POST" action="<?php echo api_get_self(); ?>">
	...
	<div id="main_bandwidthstats">
		...
		<div id="extension_content_bandwidthstats" style="display:none" class="accordion_content">
			...
			<table width="100%">
				<tr>
					<td width="50%" align="center">
						<?php Display::display_icon('bandwidth_avatar.png', get_lang('BandWidthStatistics')); ?>
					</td>
					<td align="center" width="50%" valign ="bottom" class="text_bandwidth">
						<form method="POST" action="<?php echo api_get_self(); ?>">
