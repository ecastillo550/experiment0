...
$NoCoursesForThisUser = "This user is enrolled in no course";
...
$ForcePasswordChangeComment = "After how many successfull logins has the password to be changed? This increases the security of the accounts of your users. If you do not want to force the users to change the password you have to enter 0.";
...
$PasswordLengthComment = "How many character should the password minimally contain";
...
$Emailtemplates = "Email templates";
$Dontedittext = "Kindly dont edit text inside paranthesis { } Eg:{Name}";
...
$EditHomePageDescription = "For select another homepage, you can to use the templates in the top of this document";
...
$UseDefaultEditorComment = "Currently we encourage you to use Fckeditor, the new online editor Ckeditor is in development phase .";
$CkEditorInfo = "Ckeditor";
$FckEditorInfo = "Fckeditor";
$dokeos2_orange_tablet = "Orange tablet";
$EnrollmentToHumanResourceManagerAtRegistrationToPortal = "Automatic enrollment to resource human manager";
$AutomaticRegistrationHumanResourceManager = "All people registered in the portal will also be assigned to default Human Resource Manager";
$HumanResourceManagerList = "Human Resource Manager list";
$DefaultHumanResourceManager = "Default Human Resource Manager";
...
$EnablePlatformChatComment = "Allow enable the chat in all pages of the portal";
