...
$langDownloadFile = "Upload AICC or SCORM ZIP file";
$learning_path_access = "Select \'Create a module\' to delete/modify/show/hide/create/add a module";
$langRoot = "root";
$langBuilder = "Create a module (authoring tool)";
$lang_edit_learnpath = "Edit name/description";
$lang_add_title_and_desc = "Rename & add desc.";
$lang_add_learnpath = "Create a module (authoring tool)";
$lang_learnpath_added = "The module was created. Now you can add learning objects and activities to it.";
$lang_delete_learnpath = "Delete the module";
$lang_learnpath_edited = "The module was successfully edited";
$lang_learnpath_deleted = "The module and all its sections have been deleted";
...
$lang_title = "title";
$langScormBuilder = "Create a module (authoring tool)";
$langCreateDoc = "Submit";
