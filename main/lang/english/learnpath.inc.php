...
$LearnPathAddedTitle = "Welcome to the Dokeos authoring tool !";
$BuildComment  = "Add learning objects and activities to your module";
$BasicOverviewComment = "Add audio comments and order learning objects in the table of contents";
$DisplayComment = "Watch the module from a learner viewpoint";
...
$lang_description = "Module settings";
$lang_title = "Title";
...
$langLearnpathMystatus = "My progress";
...
$lang_add_learnpath = "Create new module (Dokeos AUTHOR)";
$lang_learnpath_added = "The module was created. Add sections and learning objects to build the module. ";
$lang_edit_learnpath = "Edit learnpath";
$lang_delete_learnpath = "Delete module";
$lang_learnpath_edited = "The module has been edited";
$lang_learnpath_deleted = "The module has been deleted";
$lang_no_publish = "do not publish";
$lang_publish = "Show to learners";
$lang_no_published = "not published";
$lang_published = "published";
$lang_add_learnpath_module = "Add a section";
$lang_add_learnpath_chapter_to_path = "Add a section to this module";
...
$lang_learnpath_module_edited = "The section was edited";
$lang_learnpath_module_deleted = "The section and steps have been deleted";
...
$lang_short_help = "To see the module from a learner viewpoint, select Display";
$lang_prereq_not_complete = "This learning object cannot display because the module prerequisites are not completed. This happens when a module imposes that you follow it step by step or get a minimum score in tests before you reach the next steps. ";
$lang_author = "Author";
$lang_date = "Date";
...
$langEnterDataNewChapter = "Adding a section to the module";
...
$langNewExerciseCreated = "The test has been added to the module";
...
$lang_empty = "This module includes no learning object.";
...
$langCreateTheExercise = "Adding a test to the module";
...
$langLPCreatedToContinue = "To continue add a section or a learning object or activity to your module.";
...
$AddLpToStart = "To start, give a title to your module";
$CreateTheLink = "Adding a link to the module";
...
$TakeSlideName = "Import slides titles";
...
$EditLPSettings = "Edit module settings";
$SaveLPSettings = "Submit";
...
$AddExercise = "Add test to module";
$AddForum = "Add forum";
$LPCreateDocument = "Add this document to the module";
...
$CourseSettings = "Module settings";
$SaveSection = "Save section";
$AddLinkToCourse = "Add link to module";
$AddAssignmentToCourse = "Add assignment to module";
$AddForumToCourse = "Add forum to module";
...
$CreateSelectTest = "Create / Select Test";
$LpOrganize = "Organize";
$LpAddPage = "Create page";
$LpSelectDocument = "Select document";
$LpLink = "Link";
$LpAddQuiz = "Create quiz";
$LpUploadQuiz = "Upload m. choice";
$LpSelectQuiz = "Select quiz";
$LpAssignment = "Assignment";
$LpNewSurvey = "New survey";
$CreateTheSurvey = "Adding a survey to the module";
$AddSurveyToCourse  = "Add survey to course";
$LpNewAssignment = "New assignment";
$EditCurrentSurvey = "Edit the current survey";
$DownloadWordTemplate = "download word template";
$DownloadPowerpointTemplate = "download powerpoint template";
$ExistingCourses = "Modules";
$DownloadExcelTemplate = "Download excel template";
$LpNewAssignment = "New asignment";
$LpSelectDefaultCourseInterface = "Display";
$LpNewInterfaceMode = "Full screen (Flash modules)";
$LpOldInterfaceMode = "With a table of contents";
$LpNoCourses = "There are no modules";
$SeriousGameConvert = "Serious Game";
$LpGameUpload = "Game upload";
$UploadQuiz = "Upload Quiz";
$CourseEmpty = "The module is empty. Click here to add content";
$SaveScenario = "Save Display Order";
$preview = "Preview";
$LpDefaultMode = "Dokeos navigation";
$LpNewWindowInterfaceMode = "Open new window (Flash modules)";
$LpSelectDefaultCourseInterfaceFixed = "Dokeos navigation (Fixed height)";
?>