...
$langFinish = "Finish";
$langCancel = "Cancel";
$langNotAllowedOrSessionTimeout = "Your session has expired due an extend period of inactivity. Please sign in again to access the requested information.";
...
$NotAllowedClickBack = "Sorry, you are not allowed to access this page. Please go back to continue navigate.";
$Exercise = "Test";
$Result = "Result";
...
$EcommerceCatalogCurrencyComment = "Please choose the currency to be used in the catalog";
$Total = "Total";
$ViewShoppingCart = "View Shopping Cart";
$ItemsInShoppingCart = "Item(s)";
$CreditCardPayment = "Credit Card Payment ";
$ModulePacks = "Module Packs";
$CreateModulePacks = "Create Module Packs";
...
$ItemAddToShoppingCart = "This item have been added to your shopping cart";
$CourseOverview = "Course Overview";
$ModulePackOverwiev = "Modules Pack Overwiev";
$EcommerceManagement = "Ecommerce Management";
$ModulesPackName = "Modules Pack Name";
$AcceptAddItemShoppingCart = "Are you sure add this item to your shopping cart?";
...
$QuizExerciseAttemptsDesc = "How many times can the learner do the quiz? In most exams, max attempt is 1. In self-learning activities, it may vary wheter preparing an exam or exploring a topic as a trial and error process";
$QuizMaxDurationMinutosDesc = "Heart surgery and pizza delivery are emergency-based competencies. Where assesing the added value of a service,or learning to listen might proove as important but less urgent. Decide if you want to add the stress of time to the strees of questions.";
...
$QuizDirectFeedbackDesc = "Want to provide the learner with maxium interactivity and optimise his/her motivation.? Provide a dedicated feedback after each answer";
