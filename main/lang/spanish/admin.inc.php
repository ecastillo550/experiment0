...
$ExternalAuthentication = "Autentificación";
...
$ForcePasswordChangeComment = "¿Después de cuántos inicios de sesión exitosos la contraseña tiene que ser cambiada?Esto aumenta la seguridad de las cuentas de los usuarios. Si no quiere forzar a los usuarios a cambiar la contraseña tienes que entrar en 0.";
...
$ReadMoreLimitTitle = "Límite para Leer más";
$ReadMoreLimitComment = "Este límite determina el número de palabras tras el cual aparecerá el link de Leer más";
$AccessControlTitle = "El control de acceso está activado en el Internet Explorer";
$AccessControlComment = "El control de acceso puede romper la navegación en Dokeos. Si su organización lo usa, debería activar esta opción para evitar este tipo de problemas.";
$CalendarTypesTitle = "¿Qué eventos deben mostrarse en el calendario?";
$CalendarTypesComment = "El calendario no muestra sólo eventos añadidos desde la aplicación del calendario, sino que también puede mostrar cualquier información relacionada con el tiempo como sesiones, eventos de la plataforma, información sobre fechas de ejercicios, asignación de fechas de caducidad, ...";
$AgendaDefaultViewTitle = "Vista predeterminada para el calendario";
$AgendaDefaultViewComment = "El calendario tiene tres vistas básicas: mes, semana y día. ¿Qué vista debe mostrarse cuando se accede a la funcionalidad de calendario?";
$MonthView = "Mes";
$WeekView = "Semana";
$DayView = "Día";
$AgendaActionIconsTitle = "¿Mostrar iconos de acción en el calendario?";
$AgendaActionIconsComment = "¿Deben los iconos de acciones (editar, eliminar, visibilidad, exportación) aparecer en las vistas mes, semana y día del calendario? Estos iconos aparecerán al pasar por encima de un evento.";
$ClickToEnableOrDisable = "Haga click para activar o desactivar";
$CourseSettingDelegationFalseClickToTrue = "Esta configuración ya no puede ser modificada por el administrador del curso. Haga click si desea cambiar esta";
$CourseSettingDelegationTrueClickToFalse = "Esta configuración ahora puede ser modificada por el administrador del curso. Haga click si desea cambiar esta";
$PlatformEvents = "Eventos de la plataforma (agenda global)";
$QuizEvents = "Eventos sobre ejercicios";
$SessionEvents = "Eventos de sesiones";
$MindmapConverterTitle = "Convertido de Mapas Mentales";
$MindmapConverterComment = "Para aprovechar las ventajas del convertidor de mapas mentales, usted necesita tener instalado Dokeos Mind sobre su servidor.";
$Trainings = "Entrenamientos";
$AddUsersToTrainings = "Agregar Usuarios a Entrenamientos";
$Report = "Informes";
$AddLearners = "Agregar Alumnos";
$ManageClasses = "Administrar Clases";
$CAS = "CAS";
$CasMainActivateTitle = "Activa CAS Principal";
$CasMainActivateComment = "Activa Comentario CAS";
$CasMainServerTitle = "Dirección del Servidor";
$CasMainServerComment = "La dirección IP o el nombre de host de su servidor de CAS";
$CasMainServerURITitle = "Ubicación de la Instalación de CAS";
$CasMainServerURIComment = "La ubicación raíz de su instalación CAS sin el nombre de host";
$CasMainPortTitle = "Puerto CAS";
$CasMainPortComment = "Puerto del Servidor CAS";
$CAS1Text = "CASV1";
$CAS2Text = "CASV2";
$SAMLText = "SAML";
$CasMainProtocolTitle = "Protocolo Usado CAS";
$CasMainProtocolComment = "Protocolo CAS usado. Si desea usar su Servidor CAS para pasar información sin el Ticket CAS, seleccione  SAML";
$CasUserAddActivateTitle = "Usuario Agrega activacion de CAS";
$CasUserAddActivateComment = "Elija esta opción si desea dokeos para agregar automáticamente los usuarios con la información enviada por el servidor CAS (Usando SAML)";
$CasUserAddLoginAttributeTitle = "XML Campo de inicio de sesión de usuario";
$CasUserAddLoginAttributeComment = "El campo XML del Ticket CAS contiene el inicio de sesión del Usuario";
$CasUserAddEmailAttributeTitle = "XML Campo para el correo electrónico del usuario";
$CasUserAddEmailAttributeComment = "El campo XML del CAS contiene el correo electrónico del usuario";
$CasUserAddFirstnameAttributeTitle = "XML Campo para el Nombre de Usuario";
$CasUserAddFirstnameAttributeComment = "El campo XML del CAS contiene el Nombre del Usuario";
$CasUserAddLastnameAttributeTitle = "Campo XML para Nombre de Usuario";
$CasUserAddLastnameAttributeComment = "El Campo XML del CAS contiene el Nombre del Usuario";
$DisplayBreadcrumbsTitle = "Mostrar Breadcrumbs";
$DisplayBreadcrumbsComment = "¿Debe mostrarse la Ruta de Navegación en el encabezado? Esto le permite regresar fácilmente de dónde viene. Por ejemplo: en la herramienta de foro va a un debate y lee todas las respuestas. En la ruta, a continuación, verá toda la jerarquía de la herramienta en el foro (foro de categoría, el foro y los comentarios) y con un solo clic puede volver a la vista de todos los temas en el foro actual o la página de inicio del foro herramienta";
$DisplayPlatformHeaderInCourseComment = "Si está habilitado, entonces tendrá un botón para amplia el encabezado y ver la plataforma de navegación fuera del curso. De esta manera el administrador de la plataforma pueden fácilmente volver a la página de administración de la plataforma sin tener que volver a la página de inicio del curso y luego a la página de administración de la plataforma";
$DisplayPlatformHeaderInCourseTitle = "Muestra la plataforma de navegación en el curso";
$DisplayContextHelpTitle = "Habilita Ayuda Contextual";
$DisplayContextHelpComment = "Con la ayuda contextual se puede ayudar a temas que son relevantes para la página que está visitando";
$CaptchaTitle = "Permite CAPTCHA";
$CaptchaComment = "Un CAPTCHA o Captcha (abreviatura de \"Prueba de Turing pública y automática para diferenciar máquinas y humanos\") es un tipo de prueba de desafío-respuesta utilizada en computación para garantizar que la respuesta no es generada por un ordenador. Permite que esto pueda prevenir que los spammers se registren en la plataforma Dokeos.";
$DisplayFeedbackMessagesTitle = "Muestra mensajes de retroalimentación";
$DisplayFeedbackMessagesComment = "Con los mensajes de retroalimentación se puede ver si una determinada acción se ha ejecutado correctamente o no";
$PortalViewTitle = "Vista del Portal";
$PortalViewComment = "Portal con Widgests o Portal Estático";
$PortalViewClassic = "Portal Estático y Clásico";
$PortalViewWidget = "Portal con widgets";
$Wysiwyg = "Barra de Herramientas";
$AddToolbar = "Agrega Barra de Herramientas";
$ToolbarName = "Nombre de la Barra de Herramientas";
$ToolbarLocation = "Ubicación de la Barra de Herramientas";
$ToolbarActiveButtons = "Activa Botones de la Barra de Herramientas";
$ToolbarWidth = "Ancho de la Barra de Herramientas";
$SavePluginSettings = "Validar";
$ToolbarHeight = "Alto de la Barra de Herramientas";
$ToolbarYourConfiguration = "Su Configuración";
$ToolbarAvailableButtons = "Botones Disponibles";
$TechnicalWiki = "Soporte técnico";
$WorldwideMap = "Mapa en todo el mundo";
$TechnicalAssistance = "Asistencia técnica";
$Videoconferencing = "Videoconferencia";
$OogieRapidLearning = "Oogie";
$CourseBuildingStudio = "Creación de cursos";
$ContentShop = "Comprar contenido";
$ExportAllCoursesList = "Exportar toda la lista de cursos";
$ExportSelectedCoursesFromCoursesList = "Exportar curso seleccionado de la lista de cursos";
$CustomHomepageTitle = "Diseño de Widget";
$HomepageViewCustom = "Vista del Widget";
$WidgetHiddenTitleBehaviourTitle = "Comportamiento de un Widget";
$ShowToggle = "Mostrar Ocultar";
$ShowOnHover = "Mostrar al pasar el cursor del ratón";
$CustomHomepageComment = "¿Cómo debe el diseño del Widget verse en la página?. Esto determina dónde los widgets se pueden agregar.";
$ForcePasswordChangeTitle = "Forzar cambio de contraseña";
$EmailTemplates = "Plantillas de Correo Electrónico";
$ToolbarTitle = "Título de la Barra de Herramientas";
$ToolbarButtonOrder = "Botón de orden de la barra de herramientas";
$ToolbarDragDropExplanation = "Puede arrastrar y soltar los botones individuales de las características que desea utilizar a uno de los 4 bares de abajo.";
$EnabledLocations = "Ubicaciones Disponibles";
$InstallationDateTitle = "Fecha de Instalación";
$InstallationDateComment = "¿Cuando instaló su Portal de Dokeos?";
$ConfigurePlugin = "Configura Plugin";
$loginpage_main = "Página de Inicio de Sesión: Área Principal";
$loginpage_menu = "Inicio de Sesión: Menú";
$campushomepage_main = "Página de Inicio del Campus: Área Principal";
$campushomepage_menu = "Página de Inicio del Campus: Menú";
$mycourses_main = "Mis Cursos: Área Principal";
$mycourses_menu = "Mis Cursos: Menú";
$header = "Encabezado";
$footer = "Pie de Página";
$Recurrence = "Recurrencia";
$CalendarDetailViewTitle = "Detalle de los elementos del Calendario";
$CalendarDetailViewComment = "¿Que tendrá que aparecer cuando  alguien de clic en uno de los eventos del calendario?";
$DetailView = "Detalle de los elementos del Calendario";
$CalendarNavigationTitle = "Calendario de Navegación";
$CalendarNavigationComment = "¿Donde se mostrará el calendario de navegación?";
$CalendarNavigationActions = "En la barra de Acciones";
$CalendarNavigationDefault = "Como parte del Calendario";
$AllowUserEditAgendaTitle = "¿Pueden los usuarios administrar el Calendario?";
$AllowUserEditAgendaTitle = "¿Pueden usuarios regulares administrar el calendario? Si selecciona que SI entonces podrá agregar, editar o eliminar eventos.";
$CanUsersMangeGroupAgendaTitle = "¿Pueden usuarios administrar la agenda del grupo?";
$CanUsersMangeGroupAgendaComment = "Si permite a los usuarios administrar la agenda del grupo, podrán agregar, editar o eliminar eventos que están dirigidos a uno o más usuarios miembros del grupo.";
$NumberOfAnnouncementsInListTitle = "Número de anuncios en la lista";
$NumberOfAnnouncementsInListComment = "¿Cuántos anuncios aparecen en la lista de la izquierda de la herramienta Anuncios?";
$CalendarExportAllTitle = "El Calendario exporta todos los eventos";
$CalendarExportAllComment = "Propociona un enlace para exportar todos los eventos de la herramienta de calendario a la vez";
$GroupScenarioFieldTitle = "Campos del Escenario del Grupo";
$GroupScenarioFieldComment = "¿Cuál de los siguientes campos tienen que estar disponibles al agregar o modificar un escenario de grupo?";
$EnrolmentToCoursesAtRegistrationToPortal = "Inscripción automática";
$ForcePasswordChangeAccountCreationTitle = "Forzar cambiar contraseña después del primer inicio de sesión";
$ServiceVisioTitle = "Videoconferencia";
$DokeosMind = "Dokeos Mental";
$TranslationTool = "Herramienta de Traducción";
$AuthoringStudio = "Estudio de Autoría";
$SiteRegistered = "Sitio Registrado";
$DokeosProFeatures = "Características Dokeos PRO";
$TrainersTraining = "Capacitación de entrenadores";
$ElearningStudio = "Estudio E-learning";
$CustomDevelopment = "Desarrollo Personalizado";
$HRIntegration = "Integración de RH";
$ShowQuizCategoryComment = "El examen permitirá agregar la categoría y nivel";
$ShowQuizCategoryTitle = "Mostrar Categoría en el examen";
$DownloadNewVersion = "Descargar la última versión";
$HidePlatformHeaderInCourse = "Ocultar el encabezado de la plataforma dentro del entrenamiento";
$ShowPlatformHeaderInCourse = "Mostrar el encabezado de la plataforma dentro del entrenamiento";
$TogglePlatformHeaderInCourse = "Permitir a los usuarios cambiar el encabezado de la plataforma";
$GroupScenarioFieldAnnouncements = "Anuncios";
$GroupScenarioFieldCalendar = "Calendario";
$GroupScenarioFieldDescription = "Descripción";
$GroupScenarioFieldDocument = "Documentos";
$GroupScenarioFieldForum = "Foro";
$GroupScenarioFieldLimit = "Número máximo de usuarios";
$GroupScenarioFieldPublicPrivateGroup = "Grupo Privado o Público";
$GroupScenarioFieldRegistration = "Registro del Grupo";
$GroupScenarioFieldUnRegistration = "Cancelar Registro del Grupo";
$GroupScenarioFieldWiki = "Wiki";
$GroupScenarioFieldWork = "Asignaciones";
$EditView = "Editar la vista de los elementos del calendario";
$ForcePasswordChangeAccountCreationComment = "¿Debería el usuario ser forzado a cambiar su contraseña después del primer inicio de sesión?";
$PasswordRuleTitle = "Reglas de Contraseñas";
$PasswordRuleComment = "Con éstas reglas puede forzar a los usuarios a elegir un contraseña fuerte y segura";
$PasswordRuleCamelCase = "CasoCamel: La Contraseña debe contener caracteres en mayúsculas y minúsculas";
$PasswordRuleNumbers = "La Contraseña debe contener al menos un número";
$PasswordRuleSymbol = "La contraseña debe contener al menos un símbolo (es decir, un carácter no alfanumérico como%! € £ @)";
$PasswordLengthTitle = "Longitud de Contraseña";
$PasswordLengthComment = "Cuantos caracteres debe contener la contraseña como mínimo";
$LoginFailLockTitle = "Bloquear al usuario si la contraseña que da es incorrecta";
$LoginFailLockComment = "¿Cuantas contraseñas incorrectas consecutivas tiene el usuario permitidas antes de que Dokeos bloquee la cuenta del usuario?Desde el momento en que el usuario se conecta correctamente inicia de nuevo con 0 intentos de inicio de sesión incorrectos. Si no desea esta función debe dejar esto en 0";
$ShowEmailTemplatesTitle = "Mostrar la herramienta de plantillas de correo electrónico";
$ShowEmailTemplatesComment = "Permite a la administración res editar  automáticamente el contenido de los correos electrónicos";
$dokeos2_blue = "Dokeos Azul";
$dokeos2_orange = "Dokeos Anaranjado";
$Emailtemplates = "Plantillas de Correo Electrónico";
$Dontedittext = "Favor de no modificar el texto dentro de los paréntesis ( ) ejemplo: (Nombre)";
$Automaticemails = "Correo Electrónico  Automático";
$ShowEmailTemplatesTitle = "Plantillas de Correos electrónicos automáticos";
$ShowEmailTemplatesComment = "Habilitar para editar las plantillas de correo electrónico automático";
$PlatformAdministratorManual = "Manual del Administrador Dokeos";
$TemplateDemo = "Demo";
$TemplateOverview = "Resumen";
$TemplateTeam = "Equipo";
$TemplateTestimonial = "Testimonio";
$NoTemplate = "Sin plantilla";
$EditHomeTemplates = "Editar plantillas de la página principal";
$TemplateHomepage = "Página de inicio";
$EditHomePageDescription = "Para seleccionar otra página de inicio, usted puede usar las plantillas ubicadas en la parte superior de éste documento";
$TemplateMyTextHere = "Mi texto aquí";
$CreatePageFromATemplate = "Crear páginas desde plantillas";
$HomePage = "Página de inicio";
$UserListInGroup = "Lista de usuarios en el grupo";
$GroupDeleted = "Grupo eliminado";
$CannotDeleteGroup = "No se puede eliminar el grupo";
$Quizsuccess = "Ha tenido éxito en el examen";
$Quizfailure = "Ha fallado en el examen";
$Notes = "Notas";
$MainSite = "Portal principal";
$IsMainSite = "Portal principal";
$IsNotMainSite = "Sub-portal";
$ManageMainAdministrators = "Administrar super administradores";
$ManageMainAdministratorsOfTheMainSite = "Gestionar super administradores del sitio principal";
$EditSuperAdmins = "Editar super administradores";
$Description = "Descripción";
$Start = "Inicio";
$dokeos2_tablet = "Tableta gris";
$dokeos2_blue_tablet = "Tableta azul";
$dokeos2_medical_tablet = "Tableta medical";
$dokeos2_red_tablet = "Tableta roja";
$dokeos2_black_tablet = "Tableta negra";
$UseDefaultEditorTitle = "Seleccione el editor en linea para su portal";
$UseDefaultEditorComment = "Actualmente recomendamos usar Fckeditor debido a que el nuevo editor en line \"Ckeditor\" está en fase de desarrollo";
$CkEditorInfo = "Ckeditor";
$FckEditorInfo = "Fckeditor";
$dokeos2_orange_tablet = "Tableta anaranjada";
$EnrollmentToHumanResourceManagerAtRegistrationToPortal = "Registro automatico al administrador de recursos humanos";
$AutomaticRegistrationHumanResourceManager = "Todas las personas registradas al portal serán incluso asignadas al administrador de recursos humanos principal";
$HumanResourceManagerList = "Lista de administradores de recursos humanos";
$DefaultHumanResourceManager = "Administrador de recursos humanos principal";
$ThereIsNoADefaultHRMAssignedAddOneOnTopList = "El principal administrador de recursos humanos no ha sido asignado";
$TabsSearch = "Pestaña buscar";
$EnablePlatformChatTitle = "Habilitar chat en toda la plataforma";
$EnablePlatformChatComment = "Permite habilitar el chat en todas las páginas del portal";
$DisablePlatformChat = "Inhabilitado";
$EnablePlatformChat = "Habilitado";
$PlatformChatRequestTitle = "Peticiones de chat en el portal";
$PlatformChatRequestComment = "Permite asignar el valor por defecto en segundos que el chat utilizará para hacer peticiones al servidor";
$ServiceVisioComment = "Activa la herramienta de videoconferencia";
$ServicePpt2lpTitle = "Oogie";
$ServicePpt2lpComment = "Activa la herramienta Oogie";
?>