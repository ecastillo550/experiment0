...
$LearnPathAddedTitle = "Bienvenido a la herramienta de creación de lecciones de Dokeos !";
...
$langTitleManipulateStudentPublication = "Modificar la tarea actual";
...
$CreateSelectTest = "Crear / Seleccionar Examen";
$LpOrganize = "Organizar";
$LpAddPage = "Crear documento";
$LpSelectDocument = "Seleccionar documento";
$LpLink = "Enlace";
$LpAddQuiz = "Crear ejercicio";
$LpUploadQuiz = "Subir ejercicio";
$LpSelectQuiz = "Seleccionar ejercicio";
$LpAssignment = "Tarea";
$LpNewSurvey = "Nueva encuesta";
$CreateTheSurvey = "Añadir encuesta a la lección";
$AddSurveyToCourse  = "Añadir encuesta a la lección";
$LpNewAssignment = "Nueva tarea";
$EditCurrentSurvey = "Editar la actual encuesta";
$DownloadWordTemplate = "Descargar plantilla word";
$DownloadPowerpointTemplate = "Descargar plantilla powerpoint";
$ExistingCourses = "Lista de lecciones";
$DownloadExcelTemplate = "Descargar plantilla excel";
$LpNewAssignment = "Nueva tarea";
$LpSelectDefaultCourseInterface = "Seleccione la interfaz por defecto para la lección";
$LpNewInterfaceMode = "Pantalla completa (modulos flash)";
$LpOldInterfaceMode = "Tabla de contenidos";
$LpNoCourses = "No hay lecciones";
$SeriousGameConvert = "Juego serio";
$LpGameUpload = "Subir juego";
$UploadQuiz = "Subir examen";
$CourseEmpty = "El módulo está vacío. Haga clic aquí para agregar un contenido";
$SaveScenario = "Guardar el orden de visualización";
$preview = "Vista Previa";
$LpDefaultMode = "Por defecto";
$LpNewWindowInterfaceMode = "Abrir nueva ventana (Modulos flash)";
$LpSelectDefaultCourseInterfaceFixed = "Dokeos navigation (Alto fijo)";
?>