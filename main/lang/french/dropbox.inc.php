...
$dropbox_lang["uploadFile"]  = "Importer";
$dropbox_lang["authors"]  = "Auteurs";
$dropbox_lang["description"]  = "Description";
$dropbox_lang["sendTo"]  = "Destinataires";
...
$dropbox_lang["justUploadInSelect"]  = "--- Transfert à moi-même uniquement ---";
...
$EditCategory = "Modifier ce dossier";
$CategoryName = "Nom du dossier";
$ErrorPleaseGiveCategoryName = "Veuillez nommer le dossier";
$CategoryAlreadyExistsEditIt = "Ce dossier existe déjà, veuillez utiliser un autre nom";
$CurrentlySeeing = "Vous êtes en train de visionner le(s) dossier(s)";
$CategoryStored = "Le dossier a été créé";
$CategoryModified = "Le dossier a été modifié";
...
$UploadMap = "Envoyer un mindmap";
$NewFolder = "Nouveau dossier";
$DownloadDokeosMind = "Dokeos MIND";
$MapsOut = "Maps envoyées";
$MapsIn = "Maps reçues";
$ok = "Valider";
?>