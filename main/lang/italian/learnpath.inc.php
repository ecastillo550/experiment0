...
$LearnPathAddedTitle = "Benvenuti nel sistema autore di moduli didattici di Dokeos!";
...
$langItemMissing2 = "elemento in questa posizione nel modulo originale Dokeos";
$langDone = "Fatto!";
...
$AddLpIntro = "<strong>Benvenuti</strong> nel sistema autore di moduli didattici di Dokeos. Puoi creare il modulo elemento per elemento. A sinistra vedrai la struttura del modulo.";
...
$AuthoringOptions = "Opzioni di redazione";
...
$CreateSelectTest = "Crea / Seleziona un Test";
$LpOrganize = "Organizza";
$LpAddPage = "Crea pagina";
$LpSelectDocument = "Seleziona il documento";
$LpLink = "Collegamento";
$LpAddQuiz = "Crea quesito";
$LpUploadQuiz = "Carica quesito";
$LpSelectQuiz = "Seleziona quesito";
$LpAssignment = "Compito assegnato";
$LpNewSurvey = "Nuovo questionario";
$CreateTheSurvey = "Allego questionario";
$AddSurveyToCourse  = "Allega un questionario";
$LpNewAssignment = "Nuovo compito";
$EditCurrentSurvey = "Modifica il questionario";
$DownloadWordTemplate = "Scarica documento modello";
$DownloadPowerpointTemplate = "Scarica il modello di presentazione";
$ExistingCourses = "Titolo";
$DownloadExcelTemplate = "Scarica un modello di foglio elettronico";
$LpNewAssignment = "Nuovo compito";
$LpSelectDefaultCourseInterface = "Scegli la modalità di visualizzazione";
$LpNewInterfaceMode = "Pieno schermo";
$LpOldInterfaceMode = "Indice a sinistra";
$LpNoCourses = "Non ci sono moduli";
$SeriousGameConvert = "Serious Game";
$LpGameUpload = "Carica la simulazione";
$UploadQuiz = "Carica quesiti";
$CourseEmpty = "Il modulo è vuoto. Clicca per aggiungere del contenuto";
$SaveScenario = "Salva l\'ordine di visualizzazione";
$preview = "Anteprima";
$LpDefaultMode = "Navigazione";
$LpNewWindowInterfaceMode = "Apri in una nuova finestra (moduli Flash)";
$LpSelectDefaultCourseInterfaceFixed = "Navigazione (altezza fissa)";
?>