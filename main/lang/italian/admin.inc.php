...
$AllowSocialToolTitle = "Abilita la sezione Comunità";
$AllowSocialToolComment = "La Comunità consente agli utenti di definire le relazioni con gli altri utenti, formando gruppi di amici. La Comunità si combina con il sistema di messaggistica, creando uno strumento di socializzazione tra amici all\'interno del portale.";
...
$ForcePasswordChangeComment = "La password è stata cambiata dopo un certo numero di accessi? Ciò migliora la sicurezza dell\'account degli utenti. Se non desideri obbligare gli utenti a cambiare password scrivi 0 (zero).";
...
$AllowStudentsToCreateGroupsInSocialTitle = "Consenti ai corsisti di creare gruppi nella Comunità";
$AllowStudentsToCreateGroupsInSocialComment = "Consenti ai corsisti di creare gruppi nella Comunità";
...
$ReadMoreLimitTitle = "Limite di \"Leggi ancora\"";
$ReadMoreLimitComment = "Viene definito il numero di parole dopo le quali apparirà il collegamento \"Leggi ancora\"";
$AccessControlTitle = "Su Internet Explorer è attivato il controllo d\'accesso";
$AccessControlComment = "Il controllo d\'accesso può impedire la navigazione in Dokeos. Se la tua organizzazione usa questa funzione, è necessario attivare l\'opzione per evitare problemi.";
$CalendarTypesTitle = "Quali eventi devono essere mostrati nel calendario?";
$CalendarTypesComment = "Il calendario non mostra solo gli eventi aggiunti manualmente, ma anche informazioni quali sessioni, eventi della piattaforma, date relative alle scadenze di test e compiti...";
$AgendaDefaultViewTitle = "Vista di default del calendario";
$AgendaDefaultViewComment = "Le viste possibili sono quella mensile, settimanale e giornaliera: quale vista si presenterà per default?";
$MonthView = "Mese";
$WeekView = "Settimana";
$DayView = "Giorno";
$AgendaActionIconsTitle = "Mostrare icone di azione nel calendario?";
$AgendaActionIconsComment = "Le icone di attività (modifica, elimina, rendi visibile, esporta) possono apparire nelle diverse viste del calendario? Esse saranno visibili passando il mouse sopra l\'evento.";
$ClickToEnableOrDisable = "Clicca per abilitare o disabilitare";
$CourseSettingDelegationFalseClickToTrue = "Questo valore non può ora essere cambiato dall\'amministratore del corso.Fai click! se vuoi cambiarlo.";
$CourseSettingDelegationTrueClickToFalse = "Questo valore può ora essere cambiato dall\'amministratore del corso.Fai click! se vuoi impedire il cambiamento. ";
$PlatformEvents = "Eventi generali della piattaforma";
$QuizEvents = "Eventi - quesito";
$SessionEvents = "Eventi - sessione";
$MindmapConverterTitle = "Convertitore Mappe mentali";
$MindmapConverterComment = "Per far funzionare il convertitore di mappe mentali DokeosMind deve essere installato nel server";
$Trainings = "Corsi";
$AddUsersToTrainings = "Aggiungi corsisti ai Corsi";
$Report = "Report";
$AddLearners = "Aggiungi corsisti";
$ManageClasses = "Gestisci le classi";
$CAS = "CAS";
$CasMainActivateTitle = "Attivazione CAS";
$CasMainActivateComment = "Vuoi attivare l\'autenticazione CAS?";
$CasMainServerTitle = "Indirizzo principale del server CAS";
$CasMainServerComment = "Indirizzo IP o URL del server CAS";
$CasMainServerURITitle = "Root directory dell\'installazione CAS";
$CasMainServerURIComment = "Root directory *escludendo* in nome dell\'Host";
$CasMainPortTitle = "porta CAS";
$CasMainPortComment = "porta CAS del server";
$CAS1Text = "CASV1";
$CAS2Text = "CASV2";
$SAMLText = "SAML";
$CasMainProtocolTitle = "Protocollo CAS  usato";
$CasMainProtocolComment = "Protocollo CAS attivo, se vuoi che il server CAS passi informazioni all\'interno del ticjet CAS, scegli SAML";
$CasUserAddActivateTitle = "Aggiunta utente tramite attivazione CAS";
$CasUserAddActivateComment = "Scegli l\'opzione se vuoi che il server CAS (con SAML) faccia aggiungere automaticamente le informazioni degli utenti a Dokeos ";
$CasUserAddLoginAttributeTitle = "Campo XML per il login dell\'Utente";
$CasUserAddLoginAttributeComment = "Campo XML del ticket CAS che contiene il login dell\'Utente";
$CasUserAddEmailAttributeTitle = "Campo XML dell\'email Utente";
$CasUserAddEmailAttributeComment = "Campo XML del ticket CAS contenente l\'email dell\'Utente";
$CasUserAddFirstnameAttributeTitle = "Campo XML del Nome Utente";
$CasUserAddFirstnameAttributeComment = "Campo XML del ticket CAS contenente il Nome Utente";
$CasUserAddLastnameAttributeTitle = "Campo XML del cognome Utente";
$CasUserAddLastnameAttributeComment = "Campo XML del ticket CAS contenente il cognome Utente";
$DisplayBreadcrumbsTitle = "Mostra la barra di navigazione";
$DisplayBreadcrumbsComment = "La barra di navigazione dev\'essere mostrata nella parte superiore della pagina? In questo modo sarà più facile ritornare sui propri passi. Ad esempio, se leggi le risposte ad un messaggio in un Forum, potrai vedere sulla barra l\'articolazione categoria / forum / argomento / messaggio e risalire la gerarchia della sezione.";
$DisplayPlatformHeaderInCourseComment = "Attivando la funzione sarà reso disponibile un pulsante per espandere l\'intestazione e poter così navigare nella piattaforma al di fuori del modulo. In tal modo l\'amministratore potrà ritornare alle pagine di amministrazione senza dover passare per la pagina iniziale della piattaforma.";
$DisplayPlatformHeaderInCourseTitle = "Mostra la barra di navigazione nei corsi";
$DisplayContextHelpTitle = "Abilita l\'help contestuale";
$DisplayContextHelpComment = "Con l\'help (aiuto) contestuale potrai avere informazioni sulla funzione della pagina che stai leggendo.";
$CaptchaTitle = "Abilita il CAPTCHA";
$CaptchaComment = "CAPTCHA (\"completely automated public Turing-test to tell computers and humans apart\", Test di Turing per riconoscere la reale presenza di una persona al computer) è un modo per verificare se la risposta ad una domanda (ad esempio un calcolo o il riconoscimento di uno scritto) è generata in modo automatico, in tal modo si impedisce a potenziali spammer l\'entrata alla piattaforma.";
$DisplayFeedbackMessagesTitle = "Mostra i messaggi di feedback";
$DisplayFeedbackMessagesComment = "Con il messaggio di feedback sarà possibile verificare la corretta esecuzione di una azione";
$PortalViewTitle = "Vista portale";
$PortalViewComment = "Portale statico o con widget";
$PortalViewClassic = "Portale statico classico";
$PortalViewWidget = "Portale con widget";
$Wysiwyg = "Wysiwyg";
$AddToolbar = "Aggiungi una barra degli strumenti";
$ToolbarName = "Nome della barra degli strumenti";
$ToolbarLocation = "Posizione della barra";
$ToolbarActiveButtons = "Pulsanti attivati nella barra";
$ToolbarWidth = "Ampiezza della barra";
$SavePluginSettings = "Salva la configurazione del plugin";
$ToolbarHeight = "Altezza della barra";
$ToolbarYourConfiguration = "Configurazione personalizzata";
$ToolbarAvailableButtons = "Pulsanti disponibili";
$TechnicalWiki = "Supporto tecnico";
$WorldwideMap = "Planisfero";
$TechnicalAssistance = "Assistenza tecnica";
$Videoconferencing = "Videoconferenza";
$OogieRapidLearning = "Oogie rapid elearning";
$CourseBuildingStudio = "Ambiente per la costruzione dei moduli";
$ContentShop = "Acquisto contenuti";
$ExportAllCoursesList = "Elenco dei moduli da esportare";
$ExportSelectedCoursesFromCoursesList = "Esporta i corsi selezionati dall\'elenco";
$CustomHomepageTitle = "Aspetto del widget";
$HomepageViewCustom = "Vista widget";
$WidgetHiddenTitleBehaviourTitle = "Comportamento dell\'intestazione del widget";
$ShowToggle = "Mostra interruttore";
$ShowOnHover = "Mostra al passaggio del mouse";
$CustomHomepageComment = "Aspetto della pagina con widget; modo in cui il widget può essere aggiunto";
$ForcePasswordChangeTitle = "Forza il cambio di password";
$EmailTemplates = "Modelli di lettera";
$DefaultInvitationContent = "Posso contattarti quando sei presente su";
$ToolbarTitle = "Intestazione della barra degli strumenti";
$ToolbarButtonOrder = "Ordine delle icone nella barra degli strumenti";
$ToolbarDragDropExplanation = "Puoi spostare le icone delle singole funzioni che intendi usare in una delle 4 barre sottostanti";
$EnabledLocations = "Localizzazioni abilitate";
$InstallationDateTitle = "Data di installazione";
$InstallationDateComment = "Quando è stato installato Dokeos?";
$ConfigurePlugin = "Configura il plugin";
$loginpage_main = "Pagina di accesso: area principale";
$loginpage_menu = "Pagina di accesso: menù";
$campushomepage_main = "Pagina iniziale del Campus: area principale";
$campushomepage_menu = "Pagina iniziale del Campus: menù";
$mycourses_main = "I miei corsi: area principale";
$mycourses_menu = "I miei corsi: menù";
$header = "Intestazione";
$footer = "Piè di pagina";
$Recurrence = "Ricorrenza";
$CalendarDetailViewTitle = "Dettaglio delle voci del calendario";
$CalendarDetailViewComment = "Cosa viene mostrato quando qualcuno  clicca su un evento nel calendario?";
$DetailView = "Dettaglio delle voci del calendario";
$CalendarNavigationTitle = "Navigazione nel calendario";
$CalendarNavigationComment = "Dove verrà posizionata la navigazione nel calendario?";
$CalendarNavigationActions = "Nella barra delle attività";
$CalendarNavigationDefault = "All\'interno del calendario";
$AllowUserEditAgendaTitle = "Gli utenti possono gestire il calendario?";
$AllowUserEditAgendaTitle = "Gli utenti normali possono gestire il calendario? Se sì, potranno aggiungere, modificare ed eliminare eventi.";
$CanUsersMangeGroupAgendaTitle = "Gli utenti possono gestire l\'agenda del gruppo?";
$CanUsersMangeGroupAgendaComment = "Se gestiscono l\'agenda, gli utenti potranno aggiungere, modificare ed eliminare eventi limitatamente all\'agenda dei gruppi di cui fanno parte";
$NumberOfAnnouncementsInListTitle = "Numero di avvisi nell\'elenco";
$NumberOfAnnouncementsInListComment = "Numero di avvisi elencati a sinistra nello strumento Avvisi";
$CalendarExportAllTitle = "Esportazione di tutti gli eventi del calendario";
$CalendarExportAllComment = "Fornire un collegamento per esportare in un colpo tutti gli eventi del calendario?";
$GroupScenarioFieldTitle = "Campi dello scenario del gruppo";
$GroupScenarioFieldComment = "Quali campi saranno disponibili nel momento in cui sarà aggiunto o modificato uno scenario del gruppo?";
$EnrolmentToCoursesAtRegistrationToPortal = "Iscrizione automatica";
$ForcePasswordChangeAccountCreationTitle = "Forza il cambiamento della password al primo accesso";
$ServiceVisioTitle = "Videoconferenza";
$DokeosMind = "Dokeos MIND";
$TranslationTool = "Traduzione";
$AuthoringStudio = "Studio Autore";
$SiteRegistered = "Sito registrato";
$DokeosProFeatures = "Funzionalità Dokeos PRO";
$TrainersTraining = "Formazione dei formatori";
$ElearningStudio = "Studio E-learning";
$CustomDevelopment = "Sviluppo personalizzato";
$HRIntegration = "Integrazione Risorse Umane";
$ShowQuizCategoryComment = "Quesiti aggregati per categoria e livelli";
$ShowQuizCategoryTitle = "Mostra la categoria del test";
$DownloadNewVersion = "Scarica l\'ultima versione";
$HidePlatformHeaderInCourse = "Nascondi la testata del Campus quando sei in un corso";
$ShowPlatformHeaderInCourse = "Mostra la testata del Campus quando sei in un corso";
$TogglePlatformHeaderInCourse = "Permetti agli utenti di nascondere la testata del Campus";
$GroupScenarioFieldAnnouncements = "Avvisi";
$GroupScenarioFieldCalendar = "Agenda";
$GroupScenarioFieldDescription = "Descrizione";
$GroupScenarioFieldDocument = "Documenti";
$GroupScenarioFieldForum = "Forum";
$GroupScenarioFieldLimit = "Numero massimo di corsisti";
$GroupScenarioFieldPublicPrivateGroup = "Gruppo pubblico o privato";
$GroupScenarioFieldRegistration = "Iscrizione al gruppo";
$GroupScenarioFieldUnRegistration = "Cancellazione dal gruppo";
$GroupScenarioFieldWiki = "Wiki";
$GroupScenarioFieldWork = "Elaborati";
$WidgetHiddenTitleBehaviourComment = "Cosa fare dell\'intestazione del widget quando è nascosto (Nota: contiene l\'icona per minimizzarlo)?";
$WidgetHomepageTitle = "Configurazione della pagina iniziale con widget";
$WidgetHomepageComment = "Quale configurazione scegli per la pagina iniziale con widget?";
$widgethomepage1 = "<img src=\"../img/coursehomepagelayout1.jpg\" />";
$EditView = "Modifica la visibilità degli eventi nell\'agenda";
...
$ForcePasswordChangeAccountCreationComment = "L\'utente sarà obbligato a cambiare la password iniziale al primo accesso?";
$PasswordRuleTitle = "Caratteristiche della password";
$PasswordRuleComment = "Queste caratteristiche renderanno la password più sicura";
$PasswordRuleCamelCase = "Nella password ci devono essere sia lettere minuscole che maiuscole";
$PasswordRuleNumbers = "La password deve contenere almeno una cifra";
$PasswordRuleSymbol = "La password deve contenere almeno un simbolo, come % ! &#128;£ @";
$PasswordLengthTitle = "Lunghezza minima della password";
$PasswordLengthComment = "Quanti caratteri deve contenere la password come minimo?";
$LoginFailLockTitle = "Blocca l\'utente se viene fornita una password errata";
$LoginFailLockComment = "Quante volte consecutive è possibile fornire la password errata prima di bloccare l\'accesso? Lascia 0 per non attivare la funzione.";
$ShowEmailTemplatesTitle = "Attiva i modelli di posta elettronica";
$ShowEmailTemplatesComment = "L\'amministratore può modificare il testo della posta elettronica spedita automaticamente";
$dokeos2_blue = "Dokeos 2 azzurro";
$dokeos2_orange = "Dokeos 2 arancione";
$Emailtemplates = "Modelli di lettera";
$Dontedittext = "Per favore: non modificare il testo tra parentesi graffe { } Es. {Name}";
$Automaticemails = "E-mail automatiche";
$ShowEmailTemplatesTitle = "Modelli e-mail automatiche";
$ShowEmailTemplatesComment = "Abilita la modifica dei modelli di e-mail automatica";
$PlatformAdministratorManual = "Dokeos: manuale dell\'amministratore";
$TemplateDemo = "Demo";
$TemplateOverview = "Panoramica";
$TemplateTeam = "Equipe";
$TemplateTestimonial = "Testimonial";
$NoTemplate = "Modello vuoto";
$EditHomeTemplates = "Modifica i modelli della pagina d\'accesso";
$TemplateHomepage = "Home";
$EditHomePageDescription = "Per scegliere una diversa pagina iniziale puoi usare i modelli sopra indicati";
$TemplateMyTextHere = "Scrivi qui...";
$CreatePageFromATemplate = "Nuova pagina";
$HomePage = "Pagina iniziale";
$UserListInGroup = "Elenco dei partecipanti al gruppo";
$GroupDeleted = "Gruppo eliminato";
$CannotDeleteGroup = "Il gruppo non può essere eliminato";
$Quizsuccess = "Il test ha avuto esito positivo";
$Quizfailure = "Il test non è stato superato";
$Showsuccesscontent = "Contenuto dell\'e-mail per il successo";
$Showfailurecontent = "Contenuto dell\'e-mail per il mancato superamento";
$Notes = "Annotazioni";
$GoogleCalendarImportTitle = "Google Calendar";
$GoogleCalendarImportComment = "Attiva l\'importazione da Google Calendar, per vedere all\'interno dell\'Agenda di Dokeos i calendari; sarà possibile aggiungere, modificare o eliminare i diversi eventi del calendario.";
$MainSite = "Sito principale";
$IsMainSite = "Portale principale";
$IsNotMainSite = "Sotto-sito";
$ManageMainAdministrators = "Gestisci i super amministratori";
$ManageMainAdministratorsOfTheMainSite = "Gestisci i super amministratori del sito principale";
$EditSuperAdmins = "Modifica i super amministratori";
$Catalogue = "Catalogo";
$Topics = "Argomenti";
$Programmes = "Iniziative";
$CatalogueManagement = "Esposizione catalogo e sistema di pagamento";
$EconomicModel = "Modello finanziario";
$Commercial = "Commerciale";
$NonCommercial = "Non commerciale";
$Visible = "Visibile";
$Onhomepage = "Sulla pagina principale";
$Notvisible = "Non visibile";
$DisplayInCatalogue = "Mostra nel catalogo";
$ProgrammeName = "Intestazione iniziativa";
$Image = "Immagine";
...
$Price = "Prezzo";
$SessionList = "Elenco Sessioni";
$CourseList = "Elenco Corsi";
$Hours = "Ore";
$PaymentMethods = "Modalità di pagamento";
$Paypal = "Paypal";
$ATOS = "ATOS";
$Cheque = "Assegno";
$Installments = "Tre rate";
$ATOSAccountNo = "Numero dell\'account ATOS";
$PaypalAccountRef = "Riferimento account Paypal";
$FirstInstallment = "Prima rata";
$Immediate = "Immediato";
$SecondInstallment = "Seconda rata";
$Delay = "Ritardo";
$ThirdInstallment = "Terza rata";
$InstallmentSplit = "Frazionamento in tre rate";
$SecondInstallmentPriceAmt = "% sul totale";
$ThirdInstallmentPriceAmt = "% sul totale";
$Weeks = "Settimana";
$MoreDetails = "Maggiori dettagli";
$OptionSelectionText = "Testo selezione opzioni";
$PaymentMessage = "Messaggio sui metodi di pagamento";
$CCPaymentMessage = "Messaggio per il pagamento con Carta di Credito";
$InstallmentPayment = "Messaggio per il pagamento in tre rate";
$ChequePayment = "Messaggio per il pagamento con assegno";
$HideDetails = "Nascondi i dettagli";
$InvoicingInformation = "Informazioni fatturazione";
$CompanyLogo = "Logo dell\'Ente";
$CompanyAddress = "Indirizzo Ente";
$BankDetails = "Coordinate bancarie";
$EmailMessage = "Invia un messaggio agli amministratori quando il pagamento è andato a buon fine";
$NotVisible = "Non visibile";
$Programme = "Locandina";
$AddTopic = "Aggiungi un argomento";
$TopicSettings = "Caratteristiche argomento";
$TopicName = "Titolo dell\'argomento";
$CatalogueVisible = "Visibile nel Catalogo";
$TopicLanguage = "Lingua";
$EditCatalogue = "Modifica il Catalogo";
$AddProgramme = "Aggiungi una locandina";
$CatalogueDescription = "Titolo Catalogo";
$Keywords = "Parole chiave";
$StudentAccess = "Giorni di accesso corsista";
$UnitPrice = "Prezzo unitario";
$Currency = "Valuta";
$Tax = "IVA";
$ProgrammeContentOptions = "Contenuto locandina";
$SessionSet = "Insieme di sessioni";
$ShouldSelect = "Il corsista può scegliere al massimo";
$Min = "minimo";
$ProgrammeSettings = "Configurazione locandina";
$SessionSettings = "Configurazione sessione";
$SessionTutor = "Tutor di sessione";
$Volume = "Volume";
$Schedule = "Orario";
$Frequency = "Frequenza";
$CoursePropertiesSession = "Proprietà del corso nella sessione";
$Repeats = "Ripetizioni";
$RepeatsOn = "Ripeti ogni";
$Endson = "Fino al";
$Ocurrences = "Occorrenza";
$Weekly = "Settimanale";
$EveryWeekday = "Quotidiano";
$BiWeekly = "Quindicinale";
$Monthly = "Mensile";
$Yearly = "Annuale";
$CourseSet = "Configurazione corso";
$Access = "Accesso";
$LearnMore = "Per saperne di più";
$AddToCart = "Aggiungi al carrello";
$ShowCatalogueTitle = "Mostra il catalogo";
$ShowCatalogueComment = "Aggiungi un commento al catalogo";
$ShowRSSInCourseTitle = "Mostra RSS nel corso";
$ShowRssInCourseComment = "Consenti la presenza di RSS in ogni corso";
$Elearning = "e-Learning";
$Blended = "e-Learning e presenza";
$FacetoFace = "In presenza";
$Certifying = "Con Certificato finale";
$dokeos2_dila = "Dokeos 2.0 D.I.L.A.";
$Register = "Iscrizione";
$Street = "Via";
$Individual = "Come individuo";
$Collectivity = "Come gruppo";
$Personally = "Iscrizione individuale";
$Seperate = "Iscrivere un\'altra persona";
$Identification = "Identificativo";
$YouWish = "Desideri:";
$TrainingCategory = "Categorie";
$ShowAutomaticGroupTitle = "Riempimento automatico dei gruppi";
$ShowAutomaticGroupComment = "Se una/un corsista è iscritta/o a un corso o a una sessione, aggiungila/o ad un gruppo del corso";
$ShowNewGroupTitle = "Crea un gruppo se non ci sono più posti disponibili";
$ShowNewGroupComment = "Se non è possibile trovare un posto libero in un gruppo, verrà creato un nuovo gruppo";
$ShowNewGroupSeatTitle = "Non ci sono posti nel gruppo";
$ShowNewGroupSeatComment = "Non ci sono posti disponibili in un gruppo appena creato";
$PriceNoExt = "Prezzo";
$PRO = "PRO";
$Import = "Importa";
...
$Caption = "Didascalia";
$DefaultImagesize = "Formato dell\'immagine da caricare: 720 x 240";
$SlidesManagement = "Gestione diapositive";
$SlidesList = "Elenco diapositive";
$Picture = "Immagine";
$YourTitle1 = "Titolo 1";
$YourTitle2 = "Titolo 2";
$YourTitle3 = "Titolo 3";
$YourCaption1 = "Didascalia 1";
$YourCaption2 = "Didascalia 2";
$YourCaption3 = "Didascalia 3";
$AltText1 = "Testo alternativo 1";
$AltText2 = "Testo alternativo 2";
$AltText3 = "Testo alternativo 3";
$SlideScenario = "Scenario diapositive";
$ShowSlide = "Mostra la diapositiva";
$SlideSpeed = "Velocità diapositiva";
$dokeos2_tablet = "Dokeos 2 tablet";
$dokeos2_blue_tablet = "Dokeos 2 blu - tablet";
$dokeos2_medical_tablet = "Dokeos 2 medical";
$dokeos2_red_tablet = "Dokeos 2 rosso - tablet";
$dokeos2_black_tablet = "Tablet nero";
$UseDefaultEditorTitle = "Seleziona un editor on-line per il portale";
$UseDefaultEditorComment = "Attualmente incoraggiamo ad usare Fckeditor, in quanto Ckeditor è in fase di sviluppo";
$CkEditorInfo = "Ckeditor";
$FckEditorInfo = "Fckeditor";
$dokeos2_orange_tablet = "Tablet arancione";
$EnrollmentToHumanResourceManagerAtRegistrationToPortal = "Assegnazione automatica all\'Amministratore delle Risorse Umane";
$AutomaticRegistrationHumanResourceManager = "Tutti gli utenti registrati vengono assegnati automaticamente all\'Amministratore delle Risorse Umane";
$HumanResourceManagerList = "Elenco degli amministratori delle risorse umane";
$DefaultHumanResourceManager = "Amministratore delle risorse umane di default";
$ThereIsNoADefaultHRMAssignedAddOneOnTopList = "L\'amministratore principale delle risorse umane non è stato ancora indicato";
$TabsSearch = "Cerca";
$EnablePlatformChatTitle = "Abilita la Chat in tutta la piattaforma";
$EnablePlatformChatComment = "Abilita l\'uso della Chat in ogni pagina del portale";
$DisablePlatformChat = "Disabilitata";
$EnablePlatformChat = "Abilitata";
$PlatformChatRequestTitle = "Richiesta Chat nel portale";
$PlatformChatRequestComment = "Assegna il valore di default (in secondi) del tempo impiegato per inviare la richiesta di Chat al server";
$ServiceVisioComment = "Attiva lo strumento Videoconferenza";
?>