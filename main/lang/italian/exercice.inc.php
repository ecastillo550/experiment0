...
$ExerciceExpiredTimeMessage = "Il tempo a disposizione è scaduto, ma le domande cui hai già risposto saranno prese in considerazione nel valutare l\'esercizio";
$ExercisesTracking = "Tracciamento dei Test";
$TrackingByQuestions = "Tracciamento per quesito";
$TrackingByQuestionsDescription = "Tracciando per quesito potrai vedere quali siano le risposte più frequenti e valutare cosa sia più difficile nel test";
$NumberOfAttempts = "Numero di tentativi";
$Scores = "Punteggi";
$AnsweredNothing = "Nessuna risposta";
$GoodAnswer = "Risposta corretta";
$WrongAnswer = "Risposta errata";
$Percent = "Percentuale";
$IntegrateQuizInCourse = "Integra il quesito in un percorso didattico";
$Highest = "Elevato";
$Average = "Media";
$Lowest = "Basso";
$ChooseWhereTheQuizIsIntegrated = "Scegli il modulo in cui integrare il quesito";
$QuizIntegratedInCourse = "Il quesito è stato integrato nel modulo";
$QuizQuestionsPool = "Archivio quesiti";
$FeedbackIfTrue = "Feedback se corretto";
$FeedbackIfFalse = "Feedback se errato";
$Reasoning = "Risposta esatta";
$QuizSelfEvaluationTitle = "Autovalutazione";
$QuizExamTitle = "Esame";
$QuizExamMessage = "Valuta e dai un voto ai corsisti come in un esame scritto";
$QuizSelfEvaluationMessage = "Permetti ai corsisti di esercitarsi e auto-valutarsi";
$AddToQuiz = "Aggiungi quesito";
$Prerequisite = "Prerequisito";
$Beginner = "Facile";
$Intermediate = "Intermedio";
$Expert = "Difficile";
$LeftSet = "Collegato a sinistra";
$RightSet = "Collegato a destra";
$OpenAnswer = "Risposta libera";
$QuizMedia = "Multimedia";
$Upload = "Carica";
$UploadQuiz = "Carica un quesito";
$Right = "Corretto";
$Wrong = "Errato";
$Answer = "Risposta";
$YourAnswers = "La tua risposta";
$CorrectAnswers = "Risposta corretta";
...
$SelectReason = "Se indicate tutte le scelte valide";
$FeedbackReason = "Risposta corretta solo se sono state indicate tutte le scelte valide";
$Truefalse = "Vero/Falso";
$Multiplechoice = "Scelta multipla";
$Multiplechoicesequence = "Sequenza di scelte multiple";
$Justifiedmultiplechoice = "Scelta multipla con spiegazione";
$Noneoftheabove = "Nessuna delle precedenti";
$Multiplechoiceimage = "Scelta multipla su immagine";
$Multiplechoicesound = "Scelta multipla su audio";
$Multiplechoicescreencast = "Scelta multipla su simulazione dello schermo";
$Multiplechoiceflash = "Scelta multipla su animazione Flash";
$Multiplechoicevideo = "Scelta multipla su video";
$Multipleinclusion = "Inclusione multipla (Cosa sono...)";
$Multipleexclusion = "Esclusione multipla (Cosa non sono...)";
$Multipleanswerimage = "Selezione multipla su immagine";
$Allitemsneeded = "Risposta corretta se indicati tutti i casi corretti";
$Fillinaword = "Riempi con una parola dopo la lettura";
$Calculatedanswer = "Risposta calcolata";
$Itemtable = "Elemento in una tabella";
$Listeningcomprehension = "Comprensione da ascolto";
$Openquestion = "Risposta aperta";
$Multiplechoicejustified = "Scelta multipla con spiegazione";
$Commentmap = "Commenta una mappa mentale";
$Wordsmatching = "Corrispondenza di parole";
$Makerightsequence = "Indica la sequenza corretta";
$Logicevidence = "Evidenza logica";
$Imagesmatching = "Corrispondenza di immagini";
$Imagezone = "Zona in immagine";
$Sequencediagram = "Sequenza in un diagramma";
$Sequencescreenshot = "Sequenza in una schermata";
$Datatable = "Dato in una tabella";
$Newcategory = "Nuova categoria";
$Numberofquestion = "Numero di quesiti";
$Crosswords = "Completa le parole crociate";
$Addblank = "Aggiungi uno spazio";
$Youtube = "YouTube";
$Categories = "Categorie";
$Showemailcontent = "Mostra il testo dell\'e-mail";
$Hideemailcontent = "Nascondi il testo dell\'e-mail";
$MarksAfterCorrection = "I voti per la risposta aperta saranno assegnati dal docente dopo la correzione";
$QuestionContour = "Quesito sul contorno";
$UploadImage = "Carica un\'immagine (png o jpg)";
$ContourAccuracy = "Accuratezza richiesta per il contorno";
$OptionalZones = "Opzione: zone da evitare";
$ContourFeedbackIfTrue = "Messaggio se il contorno è accettabile";
$ContourFeedbackIfFalse = "Messaggio se il contorno non è accettabile";
$DrawPolygon = "Disegna un poligono";
$DelineationText1 = "Click sinistro per ruotare";
$DelineationText2 = "Click destro per chiudere il poligono";
$SearchEngineKeywords = "Parole chiave per la ricerca";
$Chronometer = "Cronometro";
$QuestionCategories = "Categorie di quesito";
$PositionBlockMedia = "Posizione media";
$TopSide = "In alto";
$RightSide = "A destra";
$NoMedia = "Nessun media";
$QuizScenario = "Scenario quesito";
$Minutes = "Minuti";
$NoTrainerComment = "Nessun commento da parte del docente";
$Total = "Totale";
?>