...
$ForcePasswordChangeComment = "Após quantos logins realizados a senha do usuario devera ser alterada ? Isso aumenta a segurança das contas de seus usuários. Se você não quer forçar os usuários a alterar a senha digie 0.";
...
$AddSessionsInCategories = "Adicionar sessões nas categorias";
...
$SpecialCreateFullBackup = "Cria um backup especial completo";
$SpecialLetMeSelectItems = "Seleção especial, deixe-me selecionar os itens";
$CreateBackup = "Criar backup";
$AllowCoachsToEditInsideTrainingSessions = "Permitir que os tutores editem dentro sessões de treinamento";
$AllowCoachsToEditInsideTrainingSessionsComment = "Permitir que os tutores editem os comentários dentro dos treinamentos";
$ShowSessionDataTitle = "Mostrar dados do título da sessão";
$ShowSessionDataComment = "Mostrar comentarios da sessão";
$SubscribeSessionsToCategory = "Registrar sessões na categoria";
$SessionListInPlatform = "Lista de sessão da plataforma";
$SessionListInCategory = "Lista de sessões nas categorias";
$ToExportSpecialSelect = "Se você deseja exportar cursos contendo sessões, o que irá garantir que essas sessões serão incluídas na exportação será necessário selecionar as sessões na lista.";
$ErrorMsgSpecialExport = "Não há cursos registrados ou não foi realizada a associação com as sessões";
$ConfigureInscription = "Definindo a página de registo";
$MsgErrorSessionCategory = "Selecione uma categoria e sessões";
$NumberOfSession = "Número de sessões";
$DeleteSelectedSessionCategory = "Exclua apenas as categorias selecionadas sem as sessões";
$DeleteSelectedFullSessionCategory = "Excluir as categorias selecionadas para as sessões";
$EditTopRegister = "Editar Notas";
$InsertTabs = "Adicionar abas";
$EditTabs = "Editar abas";
$IsAdministrator = "É o administrador";
$IsNotAdministrator = "Não é o administrador";
$AddTimeLimit = "Adicionar limite de tempo";
$EditTimeLimit = "Editar limite de tempo";
$TheTimeLimitsAreReferential = "O limite de temo de uma categoria é referencial, não afetará os limites de uma sessão do curso";
$ShowGlossaryInExtraToolsTitle = "Mostrar os termos do glossário em ferramentas extras";
$ShowGlossaryInExtraToolsComment = "A partir deste ponto você pode configurar e adicionar os termos do glossário em ferramentas extras com a ferramenta de rota de aprendizageme exercicíos";
$FieldTypeTag = "Utilizar tag";
$SendEmailToAdminTitle = "E-mail de alerta de criação de um novo curso";
$SendEmailToAdminComment = "Envie um email para administardor da plataforma, cada vez que o professor registrar um novo curso";
$UserTag = "Utilizar tag";
$SelectSession = "Selecionar sessão";
$GroupPermissions = "Permissões do Grupo";
$SpecialCourse = "Curso especial";
$MathMimetexTitle = "mimeTEX editor de matemática";
$MathMimetexComment = "Habilitar o editor matemática mimeTeX";
$MathASCIImathMLTitle = "Editor de matemática SCIImathML";
$MathASCIImathMLComment = "Habilitar o editor de matemática SCIImathML";
$YoutubeForStudentsTitle = "Permitir aos alunos inserir vídeos do YouTube";
$YoutubeForStudentsComment = "Ativar a possibilidade de que os alunos podem inserir vídeos Youtube";
$BlockCopyPasteForStudentsTitle = "Bloquear os alunos de copiar e colar";
$BlockCopyPasteForStudentsComment = "Bloquear os alunos de copiar e colar com o editor WYSIWYG";
$MoreButtonsForMaximizedModeTitle = "Botões da barra Estendida";
$MoreButtonsForMaximizedModeComment = "Ativar os botões da barras de estendida quando o editor WYSIWYG for maximizado";
$Editor = "Editores";
$GoToCourseAfterLoginTitle = "Ir diretamente para o curso após o login";
...
$AllowStudentsDownloadFoldersTitle = "Permitir aos alunos fazer download de diretórios";
$AllowStudentsDownloadFoldersComment = "Permitir que os alunos agrupar e fazer download de um diretório completo da ferramenta de documento";
$AllowStudentsToCreateGroupsInSocialTitle = "Permitir aos alunos criar grupos em redes sociais";
$AllowStudentsToCreateGroupsInSocialComment = "Permitir aos alunos criar grupos em redes sociais";
...
$TabsSocial = "Abas de redes sociais";
$MessageMaxUploadFilesizeTitle = "Tamanho máximo de upload de arquivos de mensagens";
$MessageMaxUploadFilesizeComment = "Tamanho máximo de upload de arquivos na ferramenta de mensagens (em Bytes)";
$AddAdditionalProfileField = "Adicionar campo no perfil do usuário";
$Username = "Nome do usuário";
$ReadMoreLimitTitle = "Leia mais limite";
$ReadMoreLimitComment = "Este limite determina a quantidade de palavras após que o link leia mais aparecerá";
$AccessControlTitle = "Controle de acesso é ativado no Internet Explorer";
$AccessControlComment = "O controle de acesso pode quebrar a navegação do Dokeos. Se a sua organização usá-lo você deverá ativar essa opção para evitar este tipo de problemas.";
$CalendarTypesTitle = "Quais eventos devem ser exibidos no calendário ?";
$CalendarTypesComment = "O calendário só poderá mostrar os eventos que você adicionar ao aplicativo calendário, mas também pode exibir outras informações relacionadas ao tempo das sessões, eventos da plataforma, informações de data dos exercícios, prazo de validade das tarefas, ...";
$AgendaDefaultViewTitle = "Padrão de exibição do calendário";
$AgendaDefaultViewComment = "O calendário tem três visualizações básicas: semana, mês e dia. Que visão deve ser exibida quando a função calendário é acessada ?";
$MonthView = "Semana";
$WeekView = "Mês";
$DayView = "Dia";
$AgendaActionIconsTitle = "Mostrar ícones das ações no calendário ?";
$AgendaActionIconsComment = "Caso a ação ícones (editar, excluir, exportar, visibilidade) aparecem na semana, mês ou dia do calendário ? Esses ícones aparecem quando o ponteiro do mouse passar sobre um evento.";
$ClickToEnableOrDisable = "Clique para ativar ou desativar";
$CourseSettingDelegationFalseClickToTrue = "Esta configuração não é substituída pelo administrador do curso. Clique se você quiser alterar";
$CourseSettingDelegationTrueClickToFalse = "Esta configuração pode ser substituída pelo administrador do curso. Clique se você quiser alterar ";
$PlatformEvents = "Eventos da plataforma (agenda global)";
$QuizEvents = "Eventos de Exercícios";
$SessionEvents = "Eventos de sessão";
$MindmapConverterTitle = "Converter Mindmap";
$MindmapConverterComment = "Para fazer com que o conversor mindmap trabalhe, você necessita ter DokeosMind rodando em seu servidor";
$Trainings = "Cursos";
$AddUsersToTrainings = "Adicionar usuários ao(s) curso(s)";
$Report = "Relatório";
$AddLearners = "Adicionar alunos";
$ManageClasses = "Gerenciar turmas";
$CAS = "CAS";
$CasMainActivateTitle = "Ativar CAS";
$CasMainActivateComment = "Você deseja ativar a autenticação CAS ?";
$CasMainServerTitle = "Endereço Principal do servidor CAS";
$CasMainServerComment = "Endereço IP ou o hostname do seu servidor CAS";
$CasMainServerURITitle = "Diretório raiz para instalação CAS";
$CasMainServerURIComment = "Diretório raiz da instalação CAS sem o host name";
$CasMainPortTitle = "Porta CAS";
$CasMainPortComment = "Porta do servidor CAS";
$CAS1Text = "CASV1";
$CAS2Text = "CASV2";
$SAMLText = "SAML";
$CasMainProtocolTitle = "Protocolo utilizado para o CAS";
$CasMainProtocolComment = "Protocolo  CAS utilizado. Se você quiser usar o servidor CAS para passar informações CAS ticket, escolha SAML";
$CasUserAddActivateTitle = "Usuário adicionar pela ativação CAS";
$CasUserAddActivateComment = "Escolha esta opção se você quiser optar que o Dokeos adicione automaticamente usuários com as informações enviadas pelo servidor CAS (usando SAML)";
$CasUserAddLoginAttributeTitle = "XML campo para login do usuário";
$CasUserAddLoginAttributeComment = "O campo XML do ticket CAS contendo o login do usuário";
$CasUserAddEmailAttributeTitle = "XML campo para o email do usuário";
$CasUserAddEmailAttributeComment = "O campo XML do ticket CAS contendo o e-mail do usuário";
$CasUserAddFirstnameAttributeTitle = "XML campo para o primeiro nome de usuário";
$CasUserAddFirstnameAttributeComment = "O campo XML do ticket CAS contendo o primeiro nome de usuário";
$CasUserAddLastnameAttributeTitle = "XML campo para o primeiro nome de usuário";
$CasUserAddLastnameAttributeComment = "O campo XML do ticket CAS contendo o primeiro nome de usuário";
$DisplayBreadcrumbsTitle = "Mostrar rastro";
$DisplayBreadcrumbsComment = "Se o rastro de navegação será exibido no cabeçalho? Isso permite a você facilmente voltar de onde você esteve. Exemplo: na ferramenta fórum você vai para uma discussão e lê todas as respostas. No rastro, então você vai ver toda a hierarquia da ferramenta fórum (categoria do fórum , tópico e post) e com um clique você pode voltar para a descrição de todos os tópicos do fórum atual ou para a página inicial da ferramenta fórum ";
$DisplayPlatformHeaderInCourseComment = "Se ativado, você terá um botão para expandir o cabeçalho e ver a plataforma de navegação fora do curso. Desta forma, o administrador da plataforma pode retornar facilmente às páginas de administração de plataformas sem ter de voltar para a página inicial do curso e depois para as páginas de administração da plataforma";
$DisplayPlatformHeaderInCourseTitle = "Visualização da navegação da plataforma de cursos";
$DisplayContextHelpTitle = "Habilitar a ajuda contextual";
$DisplayContextHelpComment = "Com a ajuda contextual você obter ajudar a temas que são relevantes para a página que você está visitando";
$CaptchaTitle = "Habilitar Captcha";
$CaptchaComment = "Um CAPTCHA ou Captcha (sigla de \"completely automated public Turing-test to tell computers and humans apart\") é um tipo de teste de desafio-resposta usado em computação para garantir que a resposta não são gerada por um computador. Ao permitir, você pode impedir que os spammers registando-se em sua plataforma Dokeos.";
$DisplayFeedbackMessagesTitle = "Visualisar feedback das mensagens";
$DisplayFeedbackMessagesComment = "Com as mensagens de feedback você poderá ver se uma determinada ação foi executada com sucesso ou não";
$PortalViewTitle = "Visualização do Portal";
$PortalViewComment = "Portal com widgets ou um portal estático";
$PortalViewClassic = "Portal clássico e estático";
$PortalViewWidget = "Portal com widgets";
$Wysiwyg = "Barra de Ferramentas";
$AddToolbar = "ADICIONAR BARRA DE FERRAMENTAS";
$ToolbarName = "Nome da barra de ferramentas";
$ToolbarLocation = "Localização da barra de ferramentas";
$ToolbarActiveButtons = "Ativar botões da barra de ferramentas";
$ToolbarWidth = "Largura da barra de ferramentas";
$SavePluginSettings = "Validar";
$ToolbarHeight = "Altura da barra de ferramentas";
$ToolbarYourConfiguration = "Sua configuração";
$ToolbarAvailableButtons = "Botões disponíveis";
$TechnicalWiki = "Suporte técnico";
$WorldwideMap = "Mapa mundial";
$TechnicalAssistance = "Assistência técnica";
$Videoconferencing = "Videoconferência";
$OogieRapidLearning = "Oogie rota de aprendizagem rápida";
$CourseBuildingStudio = "Estudio de construção de cursos";
$ContentShop = "Fábrica de Conteúdo";
$ExportAllCoursesList = "Exportar lista de todos os cursos";
$ExportSelectedCoursesFromCoursesList = "Exportação cursos selecionados a partir da lista cursos";
$CustomHomepageTitle = "Widget layout";
$HomepageViewCustom = "Visualização de Widget";
$WidgetHiddenTitleBehaviourTitle = "Comportamento do título do widget";
$ShowToggle = "Alternar visualização";
$ShowOnHover = "Foco da visualização";
$CustomHomepageComment = "Como deverá ser o layout da página do widget. Isto determina onde os widgets podem ser adicionados.";
$ForcePasswordChangeTitle = "Forçar alteração de senha";
$EmailTemplates = "Modelos de Email";
$DefaultInvitationContent = "Pode entrar em contato com você quando você está online no";
$ToolbarTitle = "Título da barra de ferramentas";
$ToolbarButtonOrder = "Botão de final da barra de ferramentas";
$ToolbarDragDropExplanation = "Você poderá arrastar e soltar os botões individuais, características que você deseja usar para uma das quatro barras abaixo.";
$EnabledLocations = "Ativar localização";
$InstallationDateTitle = "Data de instalação";
$InstallationDateComment = "Quando seu portal Dokeos foi instalado?";
$ConfigurePlugin = "Configurar o plugin";
$loginpage_main = "Página de Login: área principal";
$loginpage_menu = "Página: de Login: menu";
$campushomepage_main = "Homepage do Campus: área principal";
$campushomepage_menu = "Homepage do Campus: menu";
$mycourses_main = "Meus cursos: área principal";
$mycourses_menu = "Meus cursos: menu";
$header = "Cabeçalho";
$footer = "Rodapé";
$Recurrence = "Regresso";
$CalendarDetailViewTitle = "Ver mais detalhes dos itens do calendário";
$CalendarDetailViewComment = "O que deve ser exibido quando alguém clica em um evento no calendário?";
$DetailView = "Ver mais detalhes dos itens do calendário";
$CalendarNavigationTitle = "Navegação do Calendário";
$CalendarNavigationComment = "Onde a navegação do calendário deverá exibida?";
$CalendarNavigationActions = "Na barra de ações";
$CalendarNavigationDefault = "Como parte do calendário";
$AllowUserEditAgendaTitle = "Os usuários podem gerenciar o calendário?";
$AllowUserEditAgendaTitle = "Os usuários podem gerenciar o calendário? Se você selecionar sim, então eles podem adicionar, editar ou excluir eventos.";
$CanUsersMangeGroupAgendaTitle = "Os usuários podem gerenciar a agenda do grupo?";
$CanUsersMangeGroupAgendaComment = "Se você permitir que os usuários gerenciem a agenda dos grupos, eles podem adicionar, editar ou excluir eventos que são dirigidos a um ou mais dos grupos que o usuário é membro.";
$NumberOfAnnouncementsInListTitle = "Número de anúncios na lista";
$NumberOfAnnouncementsInListComment = "Quantos anúncios devem aparecem na lista do lado esquerdo da ferramenta";
$CalendarExportAllTitle = "Exportar todos os eventos do calendário";
$CalendarExportAllComment = "Fornecer um link para exportar todos os eventos da ferramenta calendário de uma vez?";
$GroupScenarioFieldTitle = "Campos do cenário grupo";
$GroupScenarioFieldComment = "Qual dos seguintes campos têm de estar disponíveis quando adicionar ou modificar um cenário do grupo?";
$EnrolmentToCoursesAtRegistrationToPortal = "Inscrição automática";
$ForcePasswordChangeAccountCreationTitle = "Forçar alteração de senha após o primeiro login";
$ServiceVisioTitle = "Videoconferência";
$DokeosMind = "Dokeos MIND";
$TranslationTool = "Ferramenta de Tradução";
$AuthoringStudio = "Estúdio autoria";
$SiteRegistered = "Site Registado";
$DokeosProFeatures = "Características Dokeos PRO";
$TrainersTraining = "Formação de Formadores";
$ElearningStudio = "E-learning Estúdio";
$CustomDevelopment = "Personalizar Desenvolvimento";
$HRIntegration = "HR Integração";
$ShowQuizCategoryComment = "O teste deverá permitir adicionar categorias e níveis";
$ShowQuizCategoryTitle = "Mostrar categoria de exercícios";
$DownloadNewVersion = "Baixe a última versão";
$HidePlatformHeaderInCourse = "Ocultar o cabeçalho da plataforma dentro do curso";
$ShowPlatformHeaderInCourse = "Mostrar o cabeçalho da plataforma dentro do curso";
$TogglePlatformHeaderInCourse = "Permitir que os usuários alterem o cabeçalho da plataforma";
$GroupScenarioFieldAnnouncements = "Anúncios";
$GroupScenarioFieldCalendar = "Calendário";
$GroupScenarioFieldDescription = "Descrição";
$GroupScenarioFieldDocument = "Documentos";
$GroupScenarioFieldForum = "Forum";
$GroupScenarioFieldLimit = "Número máximo de usuários";
$GroupScenarioFieldPublicPrivateGroup = "Grupo privado ou público";
$GroupScenarioFieldRegistration = "Registro do Grupo";
$GroupScenarioFieldUnRegistration = "Cancelamento de registro do Grupo";
$GroupScenarioFieldWiki = "Wiki";
$GroupScenarioFieldWork = "Atribuições";
$WidgetHiddenTitleBehaviourComment = "Como deve se comportar o título do widget quando foi escondido? O título do widget contém seus ícones e também recolher o widget";
$WidgetHomepageTitle = "Layout do Widget na Página Inicial";
$WidgetHomepageComment = "Que layout você deseja para a página inicial do widget";
$widgethomepage1 = "<img src=\"../img/coursehomepagelayout1.jpg\" />";
$EditView = "Editar a visualização dos itens de calendário";
$widgethomepage2 = "<img src=\"../img/coursehomepagelayout2.jpg\" />";
$widgethomepage3 = "<img src=\"../img/coursehomepagelayout3.jpg\" />";
$widgethomepage4 = "<img src=\"../img/coursehomepagelayout4.jpg\" />";
$widgethomepage5 = "<img src=\"../img/coursehomepagelayout5.jpg\" />";
$widgethomepage6 = "<img src=\"../img/coursehomepagelayout6.jpg\" />";
$ForcePasswordChangeAccountCreationComment = "Deverá o usuário ser forçado a mudar sua senha após o primeiro login?";
$PasswordRuleTitle = "Regras de senha";
$PasswordRuleComment = "Com estas regras você pode forçar os usuários a escolher uma senha forte e segura";
$PasswordRuleCamelCase = "CamelCase: A senha deve conter letras minúsculas e maiúsculas.";
$PasswordRuleNumbers = "A senha deve conter pelo menos um número.";
$PasswordRuleSymbol = "A senha deve conter pelo menos um símbolo (ou seja, um caractere não alfanumérico, como %! € £ @).";
$PasswordLengthTitle = "Comprimento de senha";
$PasswordLengthComment = "A senha deverá conter no mínimo vários caracteres";
$LoginFailLockTitle = "Bloquear usuário se a senha errada é informada";
$LoginFailLockComment = "Quantas senhas errado consecutivas o usuário é autorizado a dar antes do bloqueio da sua conta do Dokeos ? A partir do momento que o usuário fizer o log corretamente o usuário começa novamente com 0 tentativas de login errados. Se você não quiser usar este recurso, você deve deixar 0";
$ShowEmailTemplatesTitle = "Mostrar a ferramenta de modelos de E-mail";
$ShowEmailTemplatesComment = "Permite a administração editar o conteúdo de e-mails automáticos";
$dokeos2_blue = "Dokeos 2 Azul";
$dokeos2_orange = "Dokeos 2 Laranja";
$Emailtemplates = "Modelos de Email";
$Dontedittext = "Por favor, não editar o texto entre parêntesis {} Exemplo: {Name}";
$Automaticemails = "E-mails automáticos";
$ShowEmailTemplatesTitle = "Modelos de emails automáticos";
$ShowEmailTemplatesComment = "Habilitar a edição de modelos de email automáticos";
$PlatformAdministratorManual = "Manual do Adminstrador Dokeos";
$TemplateDemo = "Demo";
$TemplateOverview = "Visão global";
$TemplateTeam = "Equipe";
$TemplateTestimonial = "Certificado";
$NoTemplate = "Nenhum modelo";
$EditHomeTemplates = "Editar página inicial modelos";
$TemplateHomepage = "Página inicial";
$EditHomePageDescription = "Para selecionar outra página, você pode usar os modelos no início deste documento";
$TemplateMyTextHere = "Meu texto aqui";
$CreatePageFromATemplate = "Criar uma página de um modelo";
$HomePage = "Página Inícial";
$UserListInGroup = "Lista de usuários do grupo";
$GroupDeleted = "Grupo excluido";
$CannotDeleteGroup = "Não é possível excluir o grupo";
$Quizsuccess = "O teste foi concluído com êxito";
$Quizfailure = "O teste não foi excedido";
$Showsuccesscontent = "O conteúdo do e-mail foi mostrado com êxito";
$Showfailurecontent = "O conteúdo do e-mail falhou";
$Notes = "Notas";
$GoogleCalendarImportTitle = "Calendário do Google";
$GoogleCalendarImportComment = "Ative a funcionalidade de importação do Calendário do Google Calendário que permite que você exiba um ou mais calendários externos para a funcionalidade da agenda do Dokeos permitindo adicionar, editar ou excluir itens do seu calendário do Google";
$MainSite = "Meu site";
$IsMainSite = "Meu portal";
$IsNotMainSite = "Subsite";
$ManageMainAdministrators = "Gerenciar de Super administradores";
$ManageMainAdministratorsOfTheMainSite = "Gerenciar Super administradores do site principal";
$EditSuperAdmins = "Editar Super administradores";
$Catalogue = "Catálogo";
$Topics = "Tópicos";
$Programmes = "Programas";
$CatalogueManagement = "Exibir Catálogo & Sistema de Pagamentos";
$EconomicModel = "Modelo Econômico";
$Commercial = "Comercial";
$NonCommercial = "Não Comercial";
$Visible = "Visível";
$Onhomepage = "Na homepage";
$Notvisible = "Não visível";
$DisplayInCatalogue = "Exibir Catálogo";
$ProgrammeName = "Nome do Programa";
$Image = "Imagem";
...
$ATOSAccountNo = "Número de Conta ATOS";
$PaypalAccountRef = "Referência da conta Paypal";
$FirstInstallment = "Primeira Parcela";
$Immediate = "Imediata";
$SecondInstallment = "Segunda Parcela";
$Delay = "Atraso";
$ThirdInstallment = "Terceira Parcela";
$InstallmentSplit = "Divisão de Parcelamento em 3 vezes";
$SecondInstallmentPriceAmt = "% do valor do preço total";
$ThirdInstallmentPriceAmt = "% do valor do preço total";
$Weeks = "Semanas";
$MoreDetails = "Mais detalhes";
$OptionSelectionText = "Opções de texto de seleção";
$PaymentMessage = "Mensagem de forma de pagamento";
$CCPaymentMessage = "Mensagem para pagamento com Cartão de Crédito";
$InstallmentPayment = "Mensagem para pagamento parcelado em 3 vezes";
$ChequePayment = "Mensagem para o pagamento de cheque";
$HideDetails = "Esconder Detalhes";
$InvoicingInformation = "Informações de faturamento";
$CompanyLogo = "Logo empresa";
$CompanyAddress = "Endereço da Empresa";
$BankDetails = "Detalhes bancários";
$EmailMessage = "Enviar e-mail para os administradores do portal quando um pagamento é validado";
$NotVisible = "Não Visivel";
$Programme = "Programa";
$AddTopic = "Adicionar Tópico";
$TopicSettings = "Configurações do Tópico";
$TopicName = "Nome do Tópico";
$CatalogueVisible = "Visível no Catálogo";
$TopicLanguage = "Idioma";
$EditCatalogue = "Editar Catálogo";
$AddProgramme = "Adicionar Programa";
$CatalogueDescription = "Descrição do Catálogo";
$Keywords = "Palavras-chave";
$StudentAccess = "Acesso dos alunos em dia";
$UnitPrice = "Preço unitário";
$Currency = "Moeda";
$Tax = "Impostos";
$ProgrammeContentOptions = "Conteúdo do programa e opções";
$SessionSet = "Configuração da sessão";
$ShouldSelect = "O aluno deverá selecionar no máximo";
$Min = "mínimo";
$ProgrammeSettings = "Configurações do Programa";
$SessionSettings = "Configurações da Sessão";
$SessionTutor = "Tutor da Sessão";
$Volume = "Volume";
$Schedule = "Calendário";
$Frequency = "Frequência";
$CoursePropertiesSession = "Propriedades da Sessão do Curso";
$Repeats = "Repetir";
$RepeatsOn = "Repetir em";
$Endson = "Finalizar em";
$Ocurrences = "Ocorrências";
$Weekly = "Semanal";
$EveryWeekday = "Toda Semana";
$BiWeekly = "Bi Semanal";
$Monthly = "Mensal";
$Yearly = "Anual";
$CourseSet = "Configurações do Curso";
$Access = "Acesso";
$LearnMore = "Saiba mais";
$AddToCart = "Adicionar ao Carrinho";
$ShowCatalogueTitle = "Visualizar Catálogo";
$ShowCatalogueComment = "Exibir catálogo de produtos para compra";
$ShowRSSInCourseTitle = "Visualizar RSS no curso";
$ShowRssInCourseComment = "Permitem ver RSS em cada curso";
$Elearning = "E-learning";
$Blended = "Misturar";
$FacetoFace = "Face a Face";
$Certifying = "Certificação";
$dokeos2_dila = "Dokeos 2.0 dila";
$Register = "Registrar";
$Street = "Rua";
$Individual = "Você é pessoa física";
$Collectivity = "Você é pessoa juridica";
$Personally = "Para o seu registro";
$Seperate = "Para registrar outra pessoa";
$Identification = "Identificação";
$YouWish = "você deseja";
$TrainingCategory = "Lista de categorias de cursos";
$ShowAutomaticGroupTitle = "Preenchimento automático de grupos";
$ShowAutomaticGroupComment = "Quando um usuário é registrado em um curso ou sessão, adicione-o para um grupo no curso";
$ShowNewGroupTitle = "Criar grupos se não houver vagas disponíveis";
$ShowNewGroupComment = "Quando não existem vagas disponíveis nos grupos para o registo automático, adicione os em um grupo";
$ShowNewGroupSeatTitle = "Grupo cheio";
$ShowNewGroupSeatComment = "N º de vagas para iniciar em um novo grupo criado";
$PriceNoExt = "Preço";
$PRO = "PRO";
$Import = "Importar";
...
$Caption = "Subtítulo";
$DefaultImagesize = "Imagens PNG ou JPG, 240x720 pixels";
$SlidesManagement = "Slider";
$SlidesList = "Lista de Slides";
$Picture = "Figura";
$YourTitle1 = "Seu Título 1";
$YourTitle2 = "Seu Título 2";
$YourTitle3 = "Seu Título 3";
$YourCaption1 = "Sua legenda 1";
$YourCaption2 = "Sua legenda 2";
$YourCaption3 = "Sua legenda 3";
$AltText1 = "Texto alternativo 1";
$AltText2 = "Texto alternativo 2";
$AltText3 = "Texto alternativo 3";
$SlideScenario = "Cenário do Slider";
$ShowSlide = "Exibir controle";
$SlideSpeed = "Velocidade do slides";
$dokeos2_tablet = "Dokeos 2 tablet";
$dokeos2_blue_tablet = "Dokeos 2 azul - tablet";
$dokeos2_medical_tablet = "Dokeos 2 medicina";
$dokeos2_red_tablet = "Dokeos 2 vermelho - tablet";
$dokeos2_black_tablet = "Black tablet";
$UseDefaultEditorTitle = "Selecione o editor on-line para o portal";
$UseDefaultEditorComment = "Atualmente recomendamos que você usar o fckeditor, o novo editor on-line CKEditor está em fase de desenvolvimento.";
$CkEditorInfo = "Ckeditor";
$FckEditorInfo = "Fckeditor";
$dokeos2_orange_tablet = "Tablet laranja";
$EnrollmentToHumanResourceManagerAtRegistrationToPortal = "Inscrição automática para gerente de recursos humanos";
$AutomaticRegistrationHumanResourceManager = "Todas as pessoas cadastradas no portal serão atribuídas como padrão de Gerente de Recursos Humanos";
$HumanResourceManagerList = "Lista de Gerentes de Recursos Humanos";
$DefaultHumanResourceManager = "Gerente de Recursos Humanos Predefinido";
$ThereIsNoADefaultHRMAssignedAddOneOnTopList = "O gerente principal de recurso humano ainda não foi atribuído";
$TabsSearch = "Guia de pesquisa";
$EnablePlatformChatTitle = "Ativar chat em toda a plataforma";
$EnablePlatformChatComment = "Permitir ativar o chat em todas as páginas do portal";
$DisablePlatformChat = "Desativado";
$EnablePlatformChat = "Ativado";
$PlatformChatRequestTitle = "Chat requisitado no portal";
$PlatformChatRequestComment = "Permitir atribuir o valor padrão em segundos para que chat use para fazer solicitações ao servidor";
$ServiceVisioComment = "Ative a ferramenta de videoconferência";
?>