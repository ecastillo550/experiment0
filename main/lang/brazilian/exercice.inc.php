...
$SessionIsReadOnly = "A sessão é apenas para leitura";
$EnableTimerControl = "Ativar controle de tempo";
...
$YouHaveToCreateAtLeastOneAnswer = "Você tem que criar pelo menos uma resposta";
$ExerciseAttempted = "Um aluno tentou um exercício";
$MultipleSelectCombination = "Seleção exata";
$MultipleAnswerCombination = "Combinação de respostas Exata";
$ExerciceExpiredTimeMessage = "Mais tempo";
$ExercisesTracking = "Exercícios de Acompanhamento";
$TrackingByQuestions = "Rastreamento por questão";
$TrackingByQuestionsDescription = "Com o controle por questão, você será capaz de ver as respostas mais comuns e avaliar o que é mais difícil no exercício.";
$NumberOfAttempts = "Número de tentativas";
$Scores = "Pontuação";
$AnsweredNothing = "Nenhuma resposta";
$GoodAnswer = "Boa resposta";
$WrongAnswer = "Resposta errada";
$Percent = "Percentagem";
$IntegrateQuizInCourse = "Integrar o questionário em um curso";
$Highest = "Maior";
$Average = "Média";
$Lowest = "Menor";
$ChooseWhereTheQuizIsIntegrated = "Escolha um curso que o questionário deverá ser integrado";
$QuizIntegratedInCourse = "O questionário foi integrado no curso";
$QuizQuestionsPool = "Arquivo de questões";
$FeedbackIfTrue = "Feedback se for verdade";
$FeedbackIfFalse = "Feedback se for falsa";
$Reasoning = "Raciocínio";
$QuizSelfEvaluationTitle = "Auto-avaliação";
$QuizExamTitle = "Exame";
$QuizExamMessage = "Avaliar os alunos e marcar como exame escrito";
$QuizSelfEvaluationMessage = "Peça aos alunos a prática para testar suas próprias habilidades";
$AddToQuiz = "Adicionar questões";
$Prerequisite = "Pré-requisito";
$Beginner = "Principiante";
$Intermediate = "Intermediária";
$Expert = "Especialista";
$LeftSet = "Conjunto esquerdo";
$RightSet = "Conjunto direito";
$OpenAnswer = "Resposta aberta";
$QuizMedia = "Mídia";
$Upload = "Upload";
$UploadQuiz = "Carregar um questionário";
$Right = "Direito";
$Wrong = "Errado";
$Answer = "Resposta";
$YourAnswers = "Sua resposta";
...
$SelectReason = "Se você digitar todas as opções válidas";
$FeedbackReason = "Resposta correta somente se todas as opções escolhidas forem validas";
$Truefalse = "Verdadeiro/Falso";
$Multiplechoice = "Múltipla Escolha";
$Multiplechoicesequence = "Múltipla Escolha de Seqüências";
$Justifiedmultiplechoice = "Múltipla Escolha Justificada";
$Noneoftheabove = "Nenhuma das acima";
$Multiplechoiceimage = "Múltipla Escolha de imagem";
$Multiplechoicesound = "Múltipla Escolha de Som";
$Multiplechoicescreencast = "Múltipla Escolha com Screencast";
$Multiplechoiceflash = "Múltipla Escolha com Flash";
$Multiplechoicevideo = "Múltipla Escolha com Vídeo";
$Multipleinclusion = "Múltiplas Inclusões (O que é ...)";
$Multipleexclusion = "Múltiplas Exclusões (o que não é ...)";
$Multipleanswerimage = "Múltiplas Respostas com imagem";
$Allitemsneeded = "Você precisa de todos desse item para tornar a resposta correta";
$Fillinaword = "Preencha com uma palavra após a leitura";
$Calculatedanswer = "Calcular Respostas";
$Itemtable = "Item de uma tabela";
$Listeningcomprehension = "Compreensão Auditiva";
$Openquestion = "Pergunta Aberta";
$Multiplechoicejustified = "Múltipla Escolha Justificada";
$Commentmap = "Comentar um Mapa";
$Wordsmatching = "Palavras Correspondentes";
$Makerightsequence = "Verifique a Seqüência Correta";
$Logicevidence = "Evidência Lógica";
$Imagesmatching = "Ccorrespondencia de Imagens";
$Imagezone = "Zona de imagem";
$Sequencediagram = "Sequência de um Diagrama";
$Sequencescreenshot = "Sequência de Screenshot";
$Datatable = "Dados de uma tabela";
$Newcategory = "Nova Categoria";
$Numberofquestion = "Número de questões";
$Crosswords = "Complete as palavras cruzadas";
$Addblank = "Adicionar em branco";
$Youtube = "You Tube";
$Categories = "Categorias";
$Showemailcontent = "Mostrar o conteúdo de e-mail";
$Hideemailcontent = "Ocultar o conteúdo do e-mail";
$MarksAfterCorrection = "As anotações das questões abertas serão dada após a correção pelo professor";
$QuestionContour = "Questão de contorno";
$UploadImage = "Upload de imagem (png ou jpg)";
$ContourAccuracy = "Precisão do contorno necessária";
$OptionalZones = "Opcional: Regiões a evitar";
$ContourFeedbackIfTrue = "Feedback se o contorno é aceitável";
$ContourFeedbackIfFalse = "Feedback se o contorno for inaceitável";
$DrawPolygon = "Desenhar um polígono";
$DelineationText1 = "Clique no botão esquerdo para girar";
$DelineationText2 = "Clique com o botão direito do mouse para fechar polígono";
$SearchEngineKeywords = "Palavras-chave mecanismo pesquisa";
$Chronometer = "Cronômetro";
$QuestionCategories = "Categorias da Questão";
$PositionBlockMedia = "Posição da mídia";
$TopSide = "Topo";
$RightSide = "Direita";
$NoMedia = "Sem mídia";
$QuizScenario = "Cenário do questionário";
$Minutes = "Minutos";
$NoTrainerComment = "Sem comentário dado pelo instrutor";
$Total = "Total";
?>