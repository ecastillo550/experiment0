...
$langFinish = "Končaj";
$langCancel = "Prekini";
$langNotAllowedOrSessionTimeout = "Za dostop nimate dovoljenja ali pa je vaša seja potekla. Poskusite s ponovno prijavo.";
...
$IcalExport = "Izvoz v iCal obliko";
...
$BackTo = "Nazaj na";
$HistoryTrainingSessions = "Zgodovina učne seje";
...
$HistoryTrainingSession = "Zgodovina tečaja";
$Until = "Do";
...
$SeeForum = "Poglej forum";
$SeeMore = "Poglej več";
$NoDataAvailable = "Nobenih podatkov ni na voljo";
$Created = "Ustvarjeno";
$LastUpdate = "Zadnje ažuriranje";
$UserNonRegisteredAtTheCourse = "Uporabnik ni registriran v tečaju";
...
$ReadTheInstallationGuide = "Preberi navodilo za namestitev";
$SeeBlog = "Poglej blog";
$Blog = "Blog";
$BlogPosts = "Objave bloga";
$BlogComments = "Komentarji bloga";
$GeneralHelp = "Splošna pomoč";
$ContextualHelp = "Vsebinska pomoč";
$VisibleFor = "Vidno za";
$List = "Seznam";
$Templates = "Predloge";
$FillTheBlanks = "Zapolni prazna mesta";
$Organize = "Organiziraj";
$UploadExcelQuiz = "Naloži excel večkr. izbira";
$Scenario = "Scenarij";
$Fill = "Napolni";
$Activity = "Aktivnost";
$Mark = "Ocena";
...
$Presence = "Prisotnost";
$Report = "Poročilo";
$Publication = "Nastavitve";
$Tutor = "Tutor";
$GprSessions = "Seje";
$Persons = "Osebe";
$CreateNewScenario = "Nov scenarij";
$SaveComment = "Uveljavi";
$SelectAction = "Izberi akcijo";
$Widget = "Gradnik";
$Configure = "Nastavi";
$Minutes = "Minut";
$AddNewComment = "Dodaj komentar";
$Average = "Povprečje";
$Never = "Nikoli";
$AutomaticRegistration = "Vsi registrirani uporabniki portala bodo avtomatično vpisani v te tečaje";
$ToolIsNowHidden = "Orodje je skrito";
$ThereAreNoTrainingsInThisCategory = "V tej kategoriji ni tečajev";
$ZipFileToUpload = "Zip datoteka za nalaganje";
$PlatformCalendar = "Globalen koledar";
$NoCourseAtPresent = "Trenutno ni tečajev";
$Oogie = "Oogie";
$Mediabox = "Mediabox";
...
$Social = "Socialno";
$Weeks = "Tednov";
$NoScenario = "Ni scenarija";
$Copy_course_content = "Kopiraj";
$PasswordIsValid = "Geslo je ustrezno.";
$PasswordShowPassword = "Prikaži geslo";
$WhichCoursesToExport = "Tečaji za izvoz";
$AccountBlocked = "Uporabniški račun blokiran";
$RSSFeed = "RSS vir";
$NumberOfItemsToDisplay = "Število elementov na prikazu";
$Location = "Lokacija";
$Quota = "Kvota";
$PaymentCost = "Stroški plačila";
$Pay = "Plačaj";
$MethodOfPayment = "Način plačila";
$MaximunSeats = "Max mest";
$MaxSeats = "Največje število mest";
$FtpServerTitle = "FTP strežnik";
$FtpServerComment = "Ime strežnika brez ftp:// predpone";
$FtpUserTitle = "FTP uporabniško ime";
$FtpUserComment = "Uporabniško ime za prijavo na FTP strežnik";
$FtpPasswordTitle = "FTP geslo";
$FtpPasswordComment = "Geslo za prijavo na FTP strežnik";
$Ftp = "FTP";
$YourStatus = "Tvoj status";
$NoStatus = "Brez statusa";
$StatusHistory = "Zgodovina statusa";
$SaveGoogle = "Shrani v Google";
$SaveGoogleCalendarEvent = "Uveljavi";
$GoogleCalendarImportedTitle = "Uvozi google koledar";
$Minimize = "Minimiziraj";
$Maximize = "Maksimiraj";
$Total = "Skupaj";
$ItemsInShoppingCart = "Element(ov)";
$ModulePacks = "Paketi modulov";
$CreateModulePacks = "Ustvari paket modulov";
$EditNotebook = "Uredi beležko";
$NewNotebook = "Nova beležka";
$OperationNotCompleted = "Operacija ni bila dokončana";
$StudentFirstNamePatternDescription = "Tečajnikovo ime";
$StudentLastNamePatternDescription = "Tečajnikov priimek";
$StudentFullNamePatternDescription = "Tečajnikovo polno ime";
$TrainerFirstNamePatternDescription = "Trenerjevo ime";
$TrainerLastNamePatternDescription = "Trenerjev priimek";
$TrainerFullNamePatternDescription = "Trenerjevo polno ime";
$DatePatternDescription = "Datum";
$ModuleNamePatternDescription = "Ime modula";
$NumApi = "API številka";
$DefaultCategoryComment = "Kako je ime privzeti kategoriji?";
?>