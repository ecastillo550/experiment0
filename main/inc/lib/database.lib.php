...
define('TABLE_MAIN_EMAILTEMPLATES', 'email_template');
define('TABLE_MAIN_QUIZ_ANSWER_TEMPLATES', 'quiz_answer_templates');
define('TABLE_MAIN_QUIZ_QUESTION_TEMPLATES', 'quiz_question_templates');
...
//User groups
define('TABLE_MAIN_GROUP',				'group_social');
...
define('TABLE_MAIN_SOCIAL_CHAT', 'user_chat');
...
define('TABLE_MAIN_PAYER_USER', 'payer_user');
define('TABLE_MAIN_PAYMENT_SETTINGS', 'payment_settings');
...
// Ecommerce
define('TABLE_MAIN_ECOMMERCE_ITEMS', 'ecommerce_items');
define('TABLE_MAIN_ECOMMERCE_LP_MODULE', 'lp_module');
define('TABLE_MAIN_ECOMMERCE_LP_MODULE_PACKS', 'lp_module_packs');

define('TABLE_MAIN_ECOMMERCE_USER_PRIVILEGES', 'ecommerce_user_privileges');

// Webex 
define('TABLE_WEBEX_USER', 'webex_user');
define('TABLE_WEBEX', 'webex');
define('TABLE_TOOL_WEBEX', 'tool_webex');
...
define('TABLE_QUIZ_SCENARIO', 'quiz_scenario');
define('TABLE_QUIZ_CATEGORY', 'quiz_category');
define('TABLE_QUIZ_TYPE', 'quiz_type');
...
// @TODO: already defined on line 72, if useful rename it (ie. "TABLE_MAIN_SURVEYGROUP")
