	...
	*/
	$sql = "CREATE TABLE IF NOT EXISTS `$TABLELP` (" .
		...
		"session_id   int	unsigned not null  default 0,".  //the session_id 
                "certif_template  int	unsigned not null  default 0,".  //the session_id 
                "certif_min_score float(6,2) NOT NULL DEFAULT '0.00',".  //the session_id 
                "certif_min_progress float(6,2) NOT NULL DEFAULT '0.00'".  //the session_id 
                ")";
...
function fill_Db_course($courseDbName, $courseRepository, $language,$default_document_array)
{
	...
	*/
	...
	Database::query("INSERT INTO `" . $tbl_course_homepage . "` VALUES (NULL, '" . TOOL_ANNOUNCEMENT . "','announcements/announcements.php?action=listing','valves.png','".string2binary(api_get_setting('course_create_active_tools', 'announcements')) . "','0','squaregrey.gif','NO','_self','authoring','0')", __FILE__, __LINE__);
	...
	*/
	...
	if(api_get_setting('enable_webex_tool')=='true')
	{
		Database::query("INSERT INTO `" . $tbl_course_homepage . "` VALUES (NULL,'" . TOOL_WEBEX . "','webex/index.php','webex_32x32.png',1,'0','squaregrey.gif',0,'_self','interaction',0)", __FILE__, __LINE__);
	}
