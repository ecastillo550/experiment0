...
include api_get_path( SYS_PATH ) . 'main/core/model/ecommerce/EcommercePaypal.php';
   ...
   //Set proxy name to PROXY_HOST and port number to PROXY_PORT in constants.php 
	...
	if (curl_errno($ch)) {
		// moving to display page to display curl errors		
		  ...
		  $location = api_get_path(WEB_PATH) . 'main/inc/lib/paypal/php_nvp_samples/APIError.php';
