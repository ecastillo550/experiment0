...
class Blog {
	...
	public static function display_form_new_post ($blog_id) {
		...
		if(!api_is_allowed_to_edit()) {
			$editor_config = array('ToolbarSet' => 'ProjectStudent', 'Width' => '98%', 'Height' => '250');
		} else {
			$editor_config = array('ToolbarSet' => 'Project', 'Width' => '98%', 'Height' => '250');
		}
			...
			$add_form->addElement('text', 'post_title', get_lang('Title'), array('size'=>'30','class'=>'focus', 'id' => 'post_title', 'onblur' => 'check_if_still_empty()'));
	...
	*/
	public static function display_minimonthcalendar ($month, $year, $blog_id) {
		...
		echo 	'<table id="smallcalendar" class="data_table" style="width:206px">',
				...
				"<th width=\"14.5%\" align=\"right\"><a href=\"", $forewardsURL, "\">&raquo;</a></th>\n", "</tr>\n";
