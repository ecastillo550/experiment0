...
CKEDITOR.lang['en'] =
{
	...
	mascot :
	{
		title		: 'Mascot Properties',
		titleButton	: 'Mascot Button Properties',
		menu		: 'Image Properties',
		infoTab		: 'Image Info',
		btnUpload	: 'Send it to the Server',
		upload		: 'Upload',
	...
	mindmaps :
	{
		title		: 'MindMaps Properties',
		titleButton	: 'MindMaps Button Properties',
		menu		: 'Image Properties',
		infoTab		: 'Image Info',
		btnUpload	: 'Send it to the Server',
		upload		: 'Upload',
	...
	docprops :
	{
        ...
        asciimath :
        {
            label_icon  : 'AsciiMath Editor Input',
            title       : 'AsciiMath Editor Input'            
        }       
};
