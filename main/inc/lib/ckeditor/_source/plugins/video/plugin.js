...
CKEDITOR.plugins.setLang( 'video', 'en', { video :
	{
		...
		poster: 'Poster image',
		sourceVideo: 'Source video(flv, mpg, mp4, avi, wmv, mov) or Streaming Url (rtmp)',
                sourceVideoHtml: 'Alternative video(ogv, mp4, webm) or Streaming Url (http) for html5',
		...
		fallbackTemplate : 'Your browser doesn\'t support video.<br>Please download the file: %links%',
                ...
                autoPlay: 'Autoplay',
                loop: 'Loop',
                fullScreen: 'Show controlbar',
                validateSrc: 'URL or Source video must not be empty.',
...
CKEDITOR.plugins.setLang( 'video', 'es', { video : {
		...
		sourceVideo: 'Archivo de video',
                sourceVideoHtml: 'Video alternativo para html5',
		sourceType : 'Tipo',
		linkTemplate :  '<a href="%src%">%type%</a> ',
		fallbackTemplate : 'Su navegador no soporta VIDEO.<br>Por favor, descargue el fichero: %links%',
                ...
                autoPlay: 'Autoplay',
                loop: 'Repetir',
                fullScreen: 'Mostrar controles',
                validateSrc: 'Ruta no debe estar vac�a.',
                invalidFileType: 'Tipo de fichero o ruta incorrecto.'
	}
} );
