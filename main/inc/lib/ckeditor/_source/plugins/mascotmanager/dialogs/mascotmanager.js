...
(function()
{
	...
	var imageDialog = function( editor, dialogType )
	{
		...
		var onImgLoadErrorEvent = function()
		{
			...
			// Set Error image.
			var noimage = CKEDITOR.getUrl( editor.skinPath + 'mascotmanager/noimage.png' );
		...
		return {
			title : editor.lang.mascot[ dialogType == 'mascotmanager' ? 'title' : 'titleButton' ],
			minWidth : 420,
			minHeight : 360,
			onShow : function()
			{
			...
			onOk : function()
			{
				...
				if ( this.imageEditMode )
				{
					...
					if ( dialogType == 'mascotmanager' && imgTagName == 'input' && confirm( editor.lang.image.button2Img ) )
					{
						// Replace INPUT-> IMG
						imgTagName = 'img';
						this.imageElement = editor.document.createElement( 'img' );
					...
					else if ( dialogType != 'mascotmanager' && imgTagName == 'img' && confirm( editor.lang.image.img2Button ))
					{
						// Replace IMG -> INPUT
						imgTagName = 'input';
	...
	CKEDITOR.dialog.add( 'mascotmanager', function( editor )
		{
			return imageDialog( editor, 'mascotmanager' );
		});
