...
if (is_int($global_error_code) && $global_error_code > 0) {
	...
	switch ($global_error_code) {
		...
		case 2:
			...
			$InstallationDescription = '<form action="main/install/index.php" method="get"><button class="save" type="submit" style="float:none;" value="&nbsp;&nbsp; '.$click_to_install.' &nbsp;&nbsp;" >'.$click_to_install.'</button></form><br />
...
<html>
		...
		<div id="header">
			...
			<div id="header2">
				<div class="headerinner">
					<ul id="dokeostabs">
						<li id="current" class="install"><a href="#">Installation</a></li>
					</ul>
