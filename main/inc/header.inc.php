...
$htmlHeadXtra[] = '<script type="text/javascript" src="'.api_get_path(WEB_LIBRARY_PATH).'javascript/jquery.mousewheel.min.js"></script>';
$htmlHeadXtra[] = '<script type="text/javascript" src="'.api_get_path(WEB_LIBRARY_PATH).'javascript/jquery.slidingtabs.pack.js"></script>';
$htmlHeadXtra[] = '    
        <script type="text/javascript">  
            $(document).ready(function() {  				
                    // Horizontal Sliding Tabs Demo
                    $("div#dokeostabs").slideTabs({
                            // Options  			
                            orientation: "horizontal",
                            slideWidth:916, // Width of the #tabs_container <div> element			
