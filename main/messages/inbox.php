...
if (api_get_setting('allow_social_tool') == 'true') {
  ...
  if ($_GET['f']=='social' || api_get_setting('allow_social_tool') == 'true') {
    ...
    echo '<a href="'.api_get_path(WEB_PATH).'main/auth/profile.php?type=reduced">'.Display::return_icon('pixel.gif', get_lang('EditNormalProfile'),array('class'=>'toolactionplaceholdericon tooledithome')).'&nbsp;'.get_lang('EditNormalProfile').'</a>';
  }
}
...
echo '<a href="'.api_get_path(WEB_PATH).'main/messages/new_message.php?f=social">'.Display::return_icon('pixel.gif',get_lang('ComposeMessage'), array('class' => 'toolactionplaceholdericon toolactionsinvite')).get_lang('ComposeMessage').'</a>';
