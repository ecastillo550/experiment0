...
function count_courses_in_category($category,$only_payment = null) {
  ...
  $sql = "SELECT * FROM $tbl_course WHERE category_code" . (empty($category) ? " IS NULL" : "='" . $category . "'")." $sqlpayment";
  ...
  if ($_configuration['multiple_access_urls']) {
    ...
    if ($url_access_id != -1) {
      ...
      $sql = "SELECT * FROM $tbl_course as course INNER JOIN $tbl_url_rel_course as url_rel_course
					...
					WHERE access_url_id = $url_access_id AND category_code" . (empty($category) ? " IS NULL" : "='" . $category . "' $sqlpayment");
    }
  }
...
function browse_courses_in_category($only_payment = null) {
  ...
  $sql = "SELECT * FROM $tbl_course WHERE category_code" . $my_category . " $sqlpayment ORDER BY title, visual_code";
