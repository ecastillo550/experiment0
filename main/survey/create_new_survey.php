...
$form->addElement('checkbox', 'anonymous', get_lang('Anonymous'));
    ...
    $radios_allinone = array();
    $radios_allinone[] = FormValidator :: createElement('static', '', null, get_lang('Questions per page'));
    $radios_allinone[] = FormValidator :: createElement('radio', 'question_per_page', get_lang('Allinone'), get_lang('One'), 0);
    $radios_allinone[] = FormValidator :: createElement('radio', 'question_per_page', null                , get_lang('All'), 1);

    $form->addGroup($radios_allinone, null, '');
