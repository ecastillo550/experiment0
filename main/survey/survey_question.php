...
echo '<script>function survey_print()
	{			
		if(document.getElementById(\'headerdiv\').style.display == "")
		{			
			document.getElementById(\'headerdiv\').style.display = "none";
		}	
		if(document.getElementById(\'footerdiv\').style.display == "")
		{			
			document.getElementById(\'footerdiv\').style.display = "none";
		}
		window.print()
		alert("Survey Printed");
		if(document.getElementById(\'headerdiv\').style.display == "none")
		{			
			document.getElementById(\'headerdiv\').style.display = "";
		}	
		if(document.getElementById(\'footerdiv\').style.display == "none")
		{			
...
//	echo '<div class="actions" style="height:auto;min-height:400px;">';
	...
	{
		echo '<table border="0" cellpadding="4" cellspacing="4" width="100%" style="border:1px solid #b8b8b6;border-radius:5px;-moz-border-radius: 5px;-webkit-border-radius: 5px;" bordercolor="#ccc">';
