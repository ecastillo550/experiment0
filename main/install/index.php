...
$update_from_version_20 = array('2.0','2.1');
$my_old_version = '';
...
<div id="header">
	...
	<div id="header4">
		<div class="headerinner">
			<div id="help-content">
				<strong><?php echo get_lang('GeneralHelp'); ?></strong><br />
				<a href="../../documentation/installation_guide.php" target="_blank"><?php echo get_lang('ReadTheInstallGuide'); ?></a><br />
				<a href="http://dokeos.com/en/manual/installation" target="_blank"><?php echo get_lang('Up2DateManualDokeosCom'); ?></a><br /><br />
				<strong><?php echo get_lang('ContextualHelp'); ?></strong><br />
				<?php
					// contextual help
					if (!$_POST){
						echo '<a href="http://dokeos.com/en/manual/installation/Dokeos/step1" target="_blank">'.get_lang('InstallationStep1Help').'</a><br />';
					}
					if ($_POST['step1']){
						echo '<a href="http://dokeos.com/en/manual/installation/Dokeos/step2" target="_blank">'.get_lang('InstallationStep2Help').'</a><br />';
					}
					if ($_POST['step2']){
						echo '<a href="http://dokeos.com/en/manual/installation/Dokeos/step3" target="_blank">'.get_lang('InstallationStep3Help').'</a><br />';
					}
					if ($_POST['step3']){
						echo '<a href="http://dokeos.com/en/manual/installation/Dokeos/step4" target="_blank">'.get_lang('InstallationStep4Help').'</a><br />';
					}
					if ($_POST['step4']){
						echo '<a href="http://dokeos.com/en/manual/installation/Dokeos/step5" target="_blank">'.get_lang('InstallationStep5Help').'</a><br />';
					}
					if ($_POST['step5']){
						echo '<a href="http://dokeos.com/en/manual/installation/Dokeos/step6" target="_blank">'.get_lang('InstallationStep6Help').'</a><br />';
					}
					if ($_POST['step6']){
						echo '<a href="http://dokeos.com/en/manual/installation/Dokeos/finalstep" target="_blank">'.get_lang('InstallationInstallationProcessHelp').'</a><br />';
					}
				?>
			</div>
			<div id="help">
				<a href="#" style="background-image: url('../img/screen-options-right.gif);" id="help-link"><?php echo get_lang('Help'); ?></a>
			</div>
		</div>
	</div>
...
?>
	...
	<table width="100%">
	<tr>
	  <td><button type="submit" class="previous_link" name="step4" value="&lt; <?php echo get_lang('Previous'); ?>" />&nbsp;&nbsp;<?php echo get_lang('Previous'); ?></button></td>
