...
/* @todo apparently this is an admin script (see $this_section and $cidReset = true so why is it stored here and not in main/admin ? */

// name of the language file that needs to be included
$language_file = array('coursebackup','admin');

// setting the help
$help_content = 'copycoursesession';
