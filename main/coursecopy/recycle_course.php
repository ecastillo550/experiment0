...
if(  (isset($_POST['action']) && $_POST['action'] == 'course_select_form' ) || (isset($_POST['recycle_option']) && $_POST['recycle_option'] == 'full_backup' ) ) {
    ...
    if(isset($_POST['action']) && $_POST['action'] == 'course_select_form' ) {
        ...
        <a style="background-image: none;" href="<?php echo api_get_path(WEB_COURSE_PATH).$course_path; ?>/index.php<?php echo $param; ?>" id="back2home" target="<?php echo $target ?>"><?php echo get_lang('langRecycleFinished'); ?></a>
        <?php
        } else {
