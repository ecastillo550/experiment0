...
if ($_SESSION['oLP']->lp_interface != 4) {
$htmlHeadXtra[] = '<script language="javascript" type="text/javascript">
  $(document).ready(function (){
     jQuery("iframe").iframeAutoHeight({minHeight:900});
  });
</script>';
}
$htmlHeadXtra[] = '<script language="JavaScript" type="text/javascript">
...
$(document).ready(function() {
     $("#content_id").load(function(){
        $("iframe#content_id").contents().find("body").css("background-color", "#FFF");
     });
 });
</script>';
...
if($_SESSION['oLP']->lp_interface == 3) {
...
} elseif ($_SESSION['oLP']->mode == 'embedded' && $_SESSION['oLP']->lp_interface == 4) {
	//not fullscreen mode
	include_once('../inc/reduced_header.inc.php');
	//$displayAudioRecorder = (api_get_setting('service_visio','active')=='true') ? true : false;
	//check if audio recorder needs to be in studentview
...
<div id="content_with_secondary_actions"  style="width:940px;height:100%;" >
    ...
    <!-- right Zone -->
	<div id="learning_path_right_zone" style="height:600px">       
        <div class="title-resource-course" style="display:none;"><?php echo isset($_SESSION['oLP']->current)?$_SESSION['oLP']->items[$_SESSION['oLP']->current]->get_title():''; ?></div>                       
		<!-- media player layaout -->
		<?php $style_media = 'style="float:right;margin:2px;"'; ?>
		<div id="media"  <?php echo $style_media ?>>
...
<!-- end left Zone -->
<!-- right Zone -->	
	<div id="learning_path_right_zone" style="<?php echo !$fullscreen?'margin-left:205px;':''; ?>height:100%;background-color:white;">	
