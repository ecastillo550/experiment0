...
if (api_get_setting('enable_certificate') === 'true') {
    ...
    $rdn_certif_score_opt[] = FormValidator :: createElement('static', '', null, get_lang('CertifEvaluationType').'<br />');
    $rdn_certif_score_opt[] = FormValidator :: createElement('radio', 'certif_evaluation_type', null, get_lang('Progress'), '1');
    $rdn_certif_score_opt[] = FormValidator :: createElement('radio', 'certif_evaluation_type', null, get_lang('Score'), '2');
